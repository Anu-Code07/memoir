...
sidebar_position: 2
description: Understanding Memoir's multi-layered isolation model for security, privacy, and compliance
---

# Isolation Boundaries

Understanding Memoir's multi-layered isolation model for security, privacy, and compliance.

## Overview

Memoir provides **four layers of isolation** that work together to ensure data security, enable multi-tenancy, and maintain privacy boundaries:
...
const memories = await memoir.memory.search(memorySpaceId, "preferences");
```
...
const cursorMemories = await memoir.memory.list({
  memorySpaceId: "shared-space",
  participantId: "cursor",
});
```
