...
The Graph Operations API (`@memoir/sdk/graph`) provides advanced graph database capabilities for Memoir, enabling multi-hop relationship queries, knowledge discovery, and cross-layer context enrichment.
...
```typescript
import { findGraphNodeId } from "@memoir/sdk/graph";
...
```typescript
import { ensureUserNode } from "@memoir/sdk/graph";
...
```typescript
import { ensureAgentNode } from "@memoir/sdk/graph";
...
```typescript
import { ensureParticipantNode } from "@memoir/sdk/graph";
...
```typescript
import { ensureEntityNode } from "@memoir/sdk/graph";
...
```typescript
import { ensureEnrichedEntityNode } from "@memoir/sdk/graph";
...
```typescript
import { GraphSyncWorker } from "@memoir/sdk/graph";
...
```typescript
import { deleteImmutableFromGraph } from "@memoir/sdk/graph";
...
```typescript
import { deleteMutableFromGraph } from "@memoir/sdk/graph";
...
```typescript
import { syncFactSupersession } from "@memoir/sdk/graph";
...
```typescript
import { updateFactGraphStatus } from "@memoir/sdk/graph";
...
```typescript
import { syncFactUpdateInPlace } from "@memoir/sdk/graph";
...
```typescript
import { syncFactRevision } from "@memoir/sdk/graph";
...
```typescript
import { getFactSupersessionChainFromGraph } from "@memoir/sdk/graph";
...
```typescript
import { removeFactSupersessionRelationships } from "@memoir/sdk/graph";
...
```typescript
import { initializeGraphSchema } from "@memoir/sdk/graph";
...
```typescript
import { verifyGraphSchema } from "@memoir/sdk/graph";
...
```typescript
import { dropGraphSchema } from "@memoir/sdk/graph";
...
```typescript
import { initialGraphSync } from "@memoir/sdk/graph";
