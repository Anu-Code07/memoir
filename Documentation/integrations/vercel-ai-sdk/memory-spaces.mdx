...
Multi-tenancy and isolation with Memoir Spaces.
...
For advanced usage, you can explicitly manage memory spaces using the Memoir SDK. Memory spaces can be registered, queried, updated, and deleted through the [Memory Space Operations API](/api-reference/memory-space-operations). This includes capabilities like:
