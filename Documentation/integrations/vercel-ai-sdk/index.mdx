...
**Package**: `@getmemoir/vercel-ai-provider` | **Version**: 0.27.2 | **SDK**: v0.21.0+ | **Status**: Production Ready
...
<ComparisonTable
  ...
  items={[
    { feature: "Vercel AI Quickstart", values: ["Learning Memoir + Vercel AI SDK", "Memory visualization, layer flow demo"] },
...
<Terminal>
memoir init my-app --template vercel-ai-quickstart
cd my-app && memoir start
</Terminal>

Open http://localhost:3000 to see:

- **Real-time Memory Orchestration** - Watch data flow through all 7 Memoir layers
...
Full-featured chat application based on [vercel/ai-chatbot](https://github.com/vercel/ai-chatbot) with Memoir replacing PostgreSQL:

<Terminal>
memoir init my-chatbot --template chat-sdk
cd my-chatbot && memoir start
</Terminal>
...
- **File Uploads** - Images, PDFs, and file attachments via Memoir Attachments
...
[View Chat SDK Documentation](https://github.com/Anu-Code07/memoir/tree/main/packages/memoir-cli/templates/chat-sdk-quickstart)
...
The Memoir Provider for Vercel AI SDK enables automatic persistent memory for AI applications built with Next.js and the Vercel AI SDK.
...
<Callout type="tip">
For async initialization (e.g., when Convex client needs to be created asynchronously), use `createMemoirMemoryAsync` instead of `createMemoirMemory`. See the [API Reference](/integrations/vercel-ai-sdk/api-reference) for details.
</Callout>
...
**Why?** Memoir properly tracks conversation participants for features like agent-to-agent memory sharing and proper attribution.
...
const memoirMemory = createMemoirMemory({
  ...
  // MEMOIR_FACT_EXTRACTION_MODEL=gpt-4o-mini
});
```
...
- Package: [`packages/vercel-ai-provider/`](https://github.com/Anu-Code07/memoir/tree/main/packages/vercel-ai-provider)
- Quickstart Demo: [`packages/vercel-ai-provider/quickstart/`](https://github.com/Anu-Code07/memoir/tree/main/packages/vercel-ai-provider/quickstart)
- NPM: [@getmemoir/vercel-ai-provider](https://www.npmjs.com/package/@getmemoir/vercel-ai-provider)
