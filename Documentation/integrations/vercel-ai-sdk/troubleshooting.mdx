...
Common issues and solutions for Memoir Provider with SDK v0.21.0+.
...
### "Cannot find module '@getmemoir/sdk'"

<Terminal>
npm install @getmemoir/sdk@latest
</Terminal>
...
3. Verify Memoir backend is deployed to Convex

### "Convex function not found"

**Cause:** Memoir schema not deployed to Convex.

**Solution:** Run `npx @getmemoir/cli init` to set up the backend, or manually copy schema files from `@getmemoir/sdk/convex-dev/`.
...
<Terminal>
npm update ai @ai-sdk/openai @getmemoir/vercel-ai-provider
</Terminal>
...
<Terminal>
npm update @getmemoir/vercel-ai-provider
</Terminal>
...
**Solution:** Use web-standard APIs only. Memoir is fully edge-compatible.
...
- [GitHub Issues](https://github.com/Anu-Code07/memoir/issues) - Bug reports
- [GitHub Discussions](https://github.com/Anu-Code07/memoir/discussions) - Questions
- [Quickstart Demo](https://github.com/Anu-Code07/memoir/tree/main/packages/vercel-ai-provider/quickstart) - Working example
