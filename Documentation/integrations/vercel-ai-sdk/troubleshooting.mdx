...
### "Cannot find module '@memoir/sdk'"

<Terminal>
npm install @memoir/sdk@latest
</Terminal>
...
**Solution:** Run `npx @memoir/cli init` to set up the backend, or manually copy schema files from `@memoir/sdk/convex-dev/`.
...
<Terminal>
npm update ai @ai-sdk/openai @memoir/vercel-ai-provider
</Terminal>
...
<Terminal>
npm update @memoir/vercel-ai-provider
</Terminal>
