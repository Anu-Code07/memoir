...
**This is NOT a Drop-In Auth Integration.** Memoir does NOT include pre-built authentication provider integrations. There is no `npm install @memoir/auth-clerk` or automatic Auth0 setup. This guide provides **generic patterns** for integrating Memoir with your existing authentication system.
</Callout>
