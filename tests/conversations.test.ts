/**
 * Memoir SDK - Conversations API E2E Tests
 *
...
describe("Conversations API (Layer 1a)", () => {
  ...
  describe("get()", () => {
    it("retrieves an existing conversation", async () => {
      ...
      // Retrieve it
      const retrieved = await memoir.conversations.get(created.conversationId);
    ...
    it("returns null for non-existent conversation", async () => {
      const result = await memoir.conversations.get(`nonexistent-${ctx.runId}`);
  ...
  describe("addMessage()", () => {
    ...
    it("appends multiple messages (immutability)", async () => {
      ...
      // Add third message
      const final = await memoir.conversations.addMessage({
        conversationId: conversation.conversationId,
        message: {
          role: "user",
    ...
    it("throws error for non-existent conversation", async () => {
      ...
      await expect(
        memoir.conversations.addMessage({
  ...
  describe("list()", () => {
    ...
    describe("sortBy options", () => {
      ...
      beforeAll(async () => {
        ...
        const convOldestResult = await memoir.conversations.create({
        ...
        const convMiddleResult = await memoir.conversations.create({
        ...
        const convNewestResult = await memoir.conversations.create({
    ...
    describe("messageCount filter", () => {
      ...
      beforeAll(async () => {
        ...
        const conv5 = await memoir.conversations.create({
        ...
        const conv10 = await memoir.conversations.create({
  ...
  describe("delete()", () => {
    ...
    it("throws error for non-existent conversation", async () => {
      await expect(
        memoir.conversations.delete(`nonexistent-${ctx.runId}`),
      ).rejects.toThrow("CONVERSATION_NOT_FOUND");
    });
  });
  ...
  describe("Storage Validation", () => {
    it("validates complete ACID properties", async () => {
      ...
      const final = await memoir.conversations.get(conversation.conversationId);
  ...
  describe("getHistory()", () => {
    ...
    it("retrieves all messages by default", async () => {
      const history = await memoir.conversations.getHistory(testConversationId);
    ...
    it("paginates messages with limit and offset", async () => {
      const page1 = await memoir.conversations.getHistory(testConversationId, {
        limit: 3,
        offset: 0,
      });
      ...
      const page2 = await memoir.conversations.getHistory(testConversationId, {
        limit: 3,
        offset: 3,
      });
    ...
    it("supports ascending order (oldest first)", async () => {
      const history = await memoir.conversations.getHistory(
        testConversationId,
        {
          sortOrder: "asc",
          limit: 3,
    ...
    it("throws error for non-existent conversation", async () => {
      ...
      // Client-side validation only checks required fields and format
      await expect(
        memoir.conversations.getHistory(`nonexistent-${ctx.runId}`),
      ).rejects.toThrow("CONVERSATION_NOT_FOUND");
    });
  });
  ...
  describe("search()", () => {
    ...
    beforeAll(async () => {
      ...
      const conv3 = await memoir.conversations.create({
  ...
  describe("export()", () => {
    ...
    it("includes metadata when requested", async () => {
      const withMetadata = await memoir.conversations.export({
    ...
    it("excludes metadata when not requested", async () => {
      const withoutMetadata = await memoir.conversations.export({
        filters: { conversationIds: [convExport1] },
        format: "json",
        includeMetadata: false,
      });
    ...
    it("handles large dataset export (100+ conversations)", async () => {
      ...
      // Export to JSON
      const jsonExport = await memoir.conversations.export({
      ...
      // Export to CSV
      const csvExport = await memoir.conversations.export({
        filters: { memorySpaceId: largeExportSpace },
        format: "csv",
        includeMetadata: false,
      });
      ...
      const deleteResult = await memoir.conversations.deleteMany(
        { memorySpaceId: largeExportSpace },
  ...
  describe("State Change Propagation", () => {
    ...
    it("message additions propagate to all read operations", async () => {
      ...
      let retrieved = await memoir.conversations.get(conv.conversationId);

      expect(retrieved!.messageCount).toBe(0);

      let listResult = await memoir.conversations.list({
        userId: propUser,
      });
      ...
      const finalHistory = await memoir.conversations.getHistory(
        conv.conversationId,
      );

      expect(finalHistory.messages).toHaveLength(5);

      const finalListResult = await memoir.conversations.list({
        userId: propUser,
      });
    ...
    it("deletion propagates to all read operations", async () => {
      ...
      let get = await memoir.conversations.get(conv.conversationId);
      ...
      get = await memoir.conversations.get(conv.conversationId);
      expect(get).toBeNull();

      listResult = await memoir.conversations.list({ userId: deleteUser });
      expect(
        listResult.conversations.some(
          (c) => c.conversationId === conv.conversationId,
        ),
  ...
  describe("Edge Cases", () => {
    ...
    it("handles very long message content", async () => {
      ...
      const result = await memoir.conversations.addMessage({
        conversationId: conv.conversationId,
        message: {
          role: "user",
          content: longContent,
    ...
    it("handles special characters in conversationId", async () => {
      ...
      const retrieved = await memoir.conversations.get(specialId);
    ...
    it("handles concurrent message additions", async () => {
      ...
      const final = await memoir.conversations.get(conv.conversationId);
  ...
  describe("Advanced Operations", () => {
    describe("deleteMany()", () => {
      ...
      it("deletes multiple conversations by userId", async () => {
        ...
        // Verify deletion
        const remaining = await memoir.conversations.list({
          userId: bulkUser,
        });
      ...
      it("dryRun returns preview without deleting", async () => {
        ...
        await memoir.conversations.deleteMany({ userId: dryRunUser });
      });
      ...
      it("confirmationThreshold blocks deletion above limit", async () => {
        ...
        await expect(
          memoir.conversations.deleteMany(
            { userId: thresholdUser },
  ...
  describe("Client-Side Validation", () => {
    ...
    describe("get() validation", () => {
      it("throws on missing conversationId", async () => {
        await expect(
          memoir.conversations.get(undefined as any),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "MISSING_REQUIRED_FIELD",
          field: "conversationId",
      ...
      it("throws on empty conversationId", async () => {
        await expect(memoir.conversations.get("")).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "MISSING_REQUIRED_FIELD",
          field: "conversationId",
        });
    ...
    describe("list() validation", () => {
      it("throws on invalid type", async () => {
        await expect(
          memoir.conversations.list({ type: "invalid" as any }),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "INVALID_TYPE",
        });
      ...
      it("throws on invalid limit (negative)", async () => {
        await expect(
          memoir.conversations.list({ limit: -1 }),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "INVALID_RANGE",
          field: "limit",
      ...
      it("throws on invalid limit (zero)", async () => {
        await expect(
          memoir.conversations.list({ limit: 0 }),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "INVALID_RANGE",
          field: "limit",
      ...
      it("throws on limit too large (>1000)", async () => {
        await expect(
          memoir.conversations.list({ limit: 1001 }),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "INVALID_RANGE",
          field: "limit",
    ...
    describe("count() validation", () => {
      it("throws on invalid type", async () => {
        await expect(
          memoir.conversations.count({ type: "wrong-type" as any }),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "INVALID_TYPE",
        });
    ...
    describe("delete() validation", () => {
      it("throws on missing conversationId", async () => {
        await expect(
          memoir.conversations.delete(undefined as any),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "MISSING_REQUIRED_FIELD",
          field: "conversationId",
      ...
      it("throws on empty conversationId", async () => {
        await expect(memoir.conversations.delete("")).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "MISSING_REQUIRED_FIELD",
          field: "conversationId",
        });
    ...
    describe("deleteMany() validation", () => {
      it("throws on invalid type", async () => {
        await expect(
          memoir.conversations.deleteMany({ type: "bad-type" as any }),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "INVALID_TYPE",
        });
      ...
      it("throws when no filters provided", async () => {
        await expect(memoir.conversations.deleteMany({})).rejects.toMatchObject(
          {
            name: "ConversationValidationError",
            code: "MISSING_REQUIRED_FIELD",
          },
    ...
    describe("getMessage() validation", () => {
      it("throws on missing conversationId", async () => {
        await expect(
          memoir.conversations.getMessage(undefined as any, "msg-123"),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "MISSING_REQUIRED_FIELD",
          field: "conversationId",
      ...
      it("throws on missing messageId", async () => {
        await expect(
          memoir.conversations.getMessage("conv-123", undefined as any),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "MISSING_REQUIRED_FIELD",
          field: "messageId",
    ...
    describe("getMessagesByIds() validation", () => {
      it("throws on missing conversationId", async () => {
        await expect(
          memoir.conversations.getMessagesByIds(undefined as any, ["msg-1"]),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "MISSING_REQUIRED_FIELD",
          field: "conversationId",
      ...
      it("throws on empty messageIds array", async () => {
        await expect(
          memoir.conversations.getMessagesByIds("conv-123", []),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "EMPTY_ARRAY",
          field: "messageIds",
    ...
    describe("findConversation() validation", () => {
      it("throws on missing memorySpaceId", async () => {
        await expect(
          memoir.conversations.findConversation({
    ...
    describe("getOrCreate() validation", () => {
      it("throws on missing memorySpaceId", async () => {
        await expect(
          memoir.conversations.getOrCreate({
            memorySpaceId: undefined as any,
            type: "user-agent",
            participants: { userId: "user-123" },
          }),
    ...
    describe("getHistory() validation", () => {
      it("throws on missing conversationId", async () => {
        await expect(
          memoir.conversations.getHistory(undefined as any),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "MISSING_REQUIRED_FIELD",
          field: "conversationId",
      ...
      it("throws on invalid limit", async () => {
        await expect(
          memoir.conversations.getHistory("conv-123", { limit: 0 }),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "INVALID_RANGE",
          field: "limit",
      ...
      it("throws on invalid offset (negative)", async () => {
        await expect(
          memoir.conversations.getHistory("conv-123", { offset: -1 }),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "INVALID_RANGE",
          field: "offset",
      ...
      it("throws on invalid sortOrder", async () => {
        await expect(
          memoir.conversations.getHistory("conv-123", {
    ...
    describe("search() validation", () => {
      it("throws on empty query", async () => {
        await expect(
          memoir.conversations.search({ query: "" }),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "EMPTY_STRING",
          field: "query",
    ...
    describe("export() validation", () => {
      it("throws on invalid format", async () => {
        await expect(
          memoir.conversations.export({ format: "xml" as any }),
        ).rejects.toMatchObject({
          name: "ConversationValidationError",
          code: "INVALID_FORMAT",
        });
  ...
  describe("Cross-Operation Integration", () => {
    it("create → addMessage → list → search → export consistency", async () => {
      ...
      // Verify in list
      const listResults = await memoir.conversations.list({
        userId: integrationUser,
      });
      ...
      const updatedGet = await memoir.conversations.get(conv.conversationId);

      expect(updatedGet!.messageCount).toBe(2);

      const updatedList = await memoir.conversations.list({
        userId: integrationUser,
      });
    ...
    it("search results update as messages are added", async () => {
      ...
      let results = await memoir.conversations.search({ query: searchTerm });
      ...
      // Should now find it
      results = await memoir.conversations.search({ query: searchTerm });
      expect(
        results.some(
          (r) => r.conversation.conversationId === conv.conversationId,
        ),
