...
export function registerConvexCommands(
  ...
  // convex deploy (alias to top-level `memoir deploy`)
  convex
    .command("deploy")
    .description("Deploy schema and functions (use 'memoir deploy' instead)")
    .option("-d, --deployment <name>", "Target deployment")
    ...
    .action(async (options, command) => {
      console.log(
        pc.yellow(
          "Note: 'memoir convex deploy' is deprecated. Use 'memoir deploy' instead.\n",
        ),
      );
  ...
  // convex update (alias to top-level `memoir update`)
  convex
    .command("update")
    .description("Update packages (use 'memoir update' instead)")
    ...
    .action(async (options, command) => {
      console.log(
        pc.yellow(
          "Note: 'memoir convex update' is deprecated. Use 'memoir update' instead.\n",
        ),
      );
  ...
  convex
    ...
    .action(async () => {
      ...
      try {
        ...
        console.log();
        printInfo("Memoir SDK Schema Tables:");
        console.log();
        ...
        console.log();
        printInfo(
          "Run 'memoir convex dashboard' to view full schema in Convex dashboard",
        );
      } catch (error) {
        spinner.stop();
        printError(
  ...
  convex
    ...
    .action(async (options) => {
      ...
      if (exitCode === 0) {
        ...
        printInfo("Run 'memoir convex dev' to start the development server");
      } else {
        console.log();
        printWarning(
