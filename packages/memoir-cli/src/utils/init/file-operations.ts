 ...
 *
 * Handles copying templates and deploying Memoir backend functions.
 */
...
/**
 * Copy Memoir backend functions from SDK to user project
 */
export async function deployMemoirBackend(projectPath: string): Promise<void> {
  ...
  console.log(pc.dim("   Copying Memoir backend functions..."));
