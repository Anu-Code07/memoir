#!/usr/bin/env node
/**
 * Memoir CLI - Command Line Interface for Memoir SDK
 *
 * A powerful tool for managing Memoir deployments, performing administrative tasks,
...
program
  .name("memoir")
  .description(
    "CLI tool for managing Memoir deployments and performing administrative tasks",
  )
  .version(VERSION)
