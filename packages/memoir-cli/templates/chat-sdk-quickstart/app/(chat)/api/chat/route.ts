...
import {
  getMemoirMemoryConfig,
  getMemorySpaceId,
} from "@/lib/memoir-config";
import {
  createStreamId,
  deleteChatById,
  getChatById,
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Note: User message storage is handled by Memoir's rememberStream()
    ...
    const stream = createUIMessageStream({
      ...
      execute: async ({ writer: dataStream }) => {
          ...
          onRecallStart: (orchestrationId) => {
            ...
            try {
              ...
              dataStream.write({
                ...
                providerMetadata: { memoir: { memoryPhase: "recall" } },
              });
          ...
          onRememberStart: (orchestrationId) => {
            ...
            try {
              ...
              dataStream.write({
                ...
                providerMetadata: { memoir: { memoryPhase: "storage" } },
              });
              // Keep existing transient event for backward compatibility
              dataStream.write({
        ...
        // See lib/auth-memoir.ts for getMemoirAuthContext() helper
        ...
        // Create Memoir memory wrapper
        const memoirMemory = await createMemoirMemoryAsync(memoirConfig);

        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        // Stream with Memoir-wrapped model
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        const result = streamText({
          model: memoirMemory(getLanguageModel(selectedChatModel)),
      ...
      onFinish: async ({ messages: finishedMessages }) => {
        // Note: Message storage is handled by Memoir's rememberStream()
        // to avoid duplicate messages in conversation history.
        ...
        if (isToolApprovalFlow) {
          for (const finishedMsg of finishedMessages) {
            ...
            if (existingMsg) {
              // Only update existing messages (Memoir messages are immutable, so this is a no-op)
              try {
                await updateMessage({
                  id: finishedMsg.id,
                ...
                // Memoir messages are immutable - this is expected to fail
              }
            }
