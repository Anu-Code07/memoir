    ...
    <div className="w-64 h-full flex flex-col bg-black/40 border-r border-white/10">
      ...
      <div className="p-4 border-b border-white/10">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-memoir-500 to-memoir-700 flex items-center justify-center">
            <span className="text-sm">🧠</span>
          </div>
          <span className="font-semibold text-sm">Memoir Demo</span>
        </div>
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-memoir-500 to-memoir-700 flex items-center justify-center text-sm font-medium">
