    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-memoir-500 to-memoir-700 flex items-center justify-center animate-pulse">
            <span className="text-3xl">🧠</span>
          </div>
          <p className="text-gray-400">Loading Memoir...</p>
        </div>
      </div>
    );
  }
    ...
    <main className="h-screen flex flex-col overflow-hidden">
      ...
      <header className="border-b border-white/10 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-memoir-500 to-memoir-700 flex items-center justify-center">
              <span className="text-xl">🧠</span>
            </div>
            <div>
              <h1 className="text-xl font-bold">Memoir Quickstart</h1>
        ...
        <div className="w-[480px] flex flex-col bg-black/20">
          <div className="p-4 border-b border-white/10">
            ...
            <p className="text-sm text-gray-400 mt-1">
              Watch data flow through Memoir layers in real-time
            </p>
          </div>
      ...
      <footer className="border-t border-white/10 px-6 py-3">
        <div className="flex items-center justify-between text-sm text-gray-500">
          <div className="flex items-center gap-4">
            <span>
              Memoir SDK {versions ? `v${versions.memoirSdk}` : "..."}
            </span>
            <span>•</span>
            ...
            {versions?.aiSdkMajor === 6 && (
              <>
                <span>•</span>
                <span className="text-memoir-400">Using ToolLoopAgent</span>
              </>
            )}
          </div>
          <a
            href="https://github.com/Anu-Code07/memoir/docs"
            target="_blank"
