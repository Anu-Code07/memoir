...
_memoir() {
    ...
    2)
      case ${COMP_WORDS[1]} in
        ...
        completion)
          ...
          ;;
        use)
          COMPREPLY=($(compgen -W "$(_memoir_deployments) --clear" -- "$cur"))
          return
          ;;
        init)
  ...
  case ${prev} in
    -d|--deployment)
      COMPREPLY=($(compgen -W "$(_memoir_deployments)" -- "$cur"))
      return
      ;;
    -f|--format)
    ...
    set-path)
      ...
      ;;
    enable|disable)
      COMPREPLY=($(compgen -W "$(_memoir_deployments) $(_memoir_apps)" -- "$cur"))
      return
      ;;
  ...
  case ${COMP_WORDS[1]} in
    ...
    dev)
      ...
      ;;
    use)
      COMPREPLY=($(compgen -W "--clear $(_memoir_deployments)" -- "$cur"))
      return
      ;;
    config)
