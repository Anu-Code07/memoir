 ...
 * Memoir SDK Mock
 *
 * Provides a complete mock of the Memoir SDK for testing CLI commands
...
/**
 * Complete mock Memoir client
 */
export const mockMemoir = {
  memory: mockMemory,
  users: mockUsers,
...
export function resetAllMocks(): void {
  ...
  (mockMemoir.close as jest.Mock).mockClear();
  (mockMemoir.getClient as jest.Mock).mockClear();
 ...
 */
export function createMockMemoirFactory() {
  return jest.fn().mockImplementation(() => mockMemoir);
}
