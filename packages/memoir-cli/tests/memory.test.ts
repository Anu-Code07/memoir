  ...
  describe("memory operations via SDK (underlying CLI operations)", () => {
    ...
    describe("memory search", () => {
      ...
      it("should search memories by content", async () => {
        const results = await memoir.memory.search(TEST_SPACE_ID, "password");
      ...
      it("should filter search by userId", async () => {
        const results = await memoir.memory.search(TEST_SPACE_ID, "test", {
          userId: TEST_USER_ID,
        });
    ...
    describe("memory stats", () => {
      it("should return memory statistics", async () => {
        // Get counts
        const totalCount = await memoir.memory.count({
          memorySpaceId: TEST_SPACE_ID,
        });
    ...
    describe("memory archive and restore", () => {
      ...
      it("should archive a memory", async () => {
        ...
        // Verify archived
        const memory = await memoir.vector.get(TEST_SPACE_ID, archiveMemoryId);
