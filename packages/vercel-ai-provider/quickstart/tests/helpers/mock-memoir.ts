 ...
 * Mock Memoir SDK
 *
 * Provides a mock implementation of the Memoir SDK for testing.
...
/**
 * Type for the mock Memoir instance
 */
export type MockMemoir = ReturnType<typeof createMockMemoir>;
