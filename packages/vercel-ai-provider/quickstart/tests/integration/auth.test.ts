 ...
 *
 * Tests the authentication API routes with mocked Memoir SDK.
 */
...
describe("Auth API Routes", () => {
  ...
  describe("GET /api/auth/check", () => {
    ...
    it("should call memoir.mutable.get with correct namespace and key", async () => {
      await checkGet();

      expect(mockMemoir.mutable.get).toHaveBeenCalledWith(
        "quickstart-config",
        "admin_password_hash",
      );
    });
  ...
  describe("POST /api/auth/setup", () => {
    ...
    it("should store hashed password and return success", async () => {
      ...
      expect(mockMemoir.mutable.set).toHaveBeenCalledWith(
        "quickstart-config",
        "admin_password_hash",
  ...
  describe("POST /api/auth/register", () => {
    ...
    it("should create user and return success with sessionToken", async () => {
      ...
      expect(mockMemoir.users.update).toHaveBeenCalledWith(
        "newuser",
  ...
  describe("POST /api/auth/login", () => {
    ...
    it("should update lastLoginAt on successful login", async () => {
      ...
      expect(mockMemoir.users.update).toHaveBeenCalledWith("testuser", {
        lastLoginAt: expect.any(Number),
      });
    });
