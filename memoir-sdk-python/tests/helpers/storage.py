"""
Storage validation utilities for Memoir Python SDK tests.
...
async def validate_conversation_storage(
    memoir_client: Memoir, conversation_id: str, expected_data: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        stored = await memoir_client.client.query(
...
async def validate_user_storage(
    memoir_client: Memoir, user_id: str, expected_data: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
    """
    ...
    try:
        # Query Convex storage directly
        stored = await memoir_client.client.query("users:get", {"userId": user_id})
