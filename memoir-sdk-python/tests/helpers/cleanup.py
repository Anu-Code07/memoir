"""
Test cleanup utilities for Memoir Python SDK tests.
...
class BatchDeleter:
    ...
    def __init__(self, memoir_client: Memoir):
        """
        Initialize BatchDeleter.

        Args:
            memoir_client: Memoir SDK instance
        """
        self.memoir = memoir_client
    ...
    async def delete_by_memory_space(
        ...
        result = await self.memoir.client.mutation(
            mutation,
...
class TestCleanup:
    ...
    async def purge_conversations(
        ...
        try:
            if memory_space_id:
                ...
                result = await self.memoir.conversations.list(
                ...
                for conv in conversations:
                    ...
                    if conv_id:
                        try:
                            await self.memoir.conversations.delete(conv_id)
                            count += 1
                        except Exception:
                            pass
            else:
                # List all conversations and filter by memory space prefix
                result = await self.memoir.conversations.list(limit=1000)
                # Handle ListConversationsResult object or raw list/dict
                if hasattr(result, 'conversations'):
                    conversations = result.conversations
                elif isinstance(result, list):
    ...
    async def purge_memories(
        ...
        try:
            ...
            result = await self.memoir.vector.list(
                memory_space_id=memory_space_id, limit=1000
            )
            ...
            for mem in memories:
                ...
                if mem_id and should_delete:
                    try:
                        await self.memoir.vector.delete(memory_space_id, mem_id)
                        count += 1
                    except Exception:
                        pass
    ...
    async def purge_facts(
        ...
        try:
            # List facts
            result = await self.memoir.facts.list(
                memory_space_id=memory_space_id, limit=1000
            )
            ...
            for fact in facts:
                ...
                if fact_id and should_delete:
                    try:
                        await self.memoir.facts.delete(memory_space_id, fact_id)
                        count += 1
                    except Exception:
                        pass
    ...
    async def purge_immutable(
        ...
        try:
            ...
            result = await self.memoir.immutable.list(
                memory_space_id=memory_space_id, limit=1000
            )
            ...
            for record in records:
                ...
                if record_id and should_delete:
                    try:
                        await self.memoir.immutable.purge(memory_space_id, record_id)
                        count += 1
                    except Exception:
                        pass
    ...
    async def purge_mutable(
        ...
        try:
            ...
            result = await self.memoir.mutable.list(
                memory_space_id=memory_space_id, limit=1000
            )
            ...
            for record in records:
                ...
                if key and should_delete:
                    try:
                        await self.memoir.mutable.delete(memory_space_id, key)
                        count += 1
                    except Exception:
                        pass
    ...
    async def purge_users(self, prefix: str = "test-user-") -> int:
        ...
        """
        from memoir.types import ListUsersFilter

        count = 0
        try:
            # List users
            result = await self.memoir.users.list(ListUsersFilter(limit=1000))
            ...
            for user in users:
                ...
                if user_id and user_id.startswith(prefix):
                    try:
                        await self.memoir.users.delete(user_id)
                        count += 1
                    except Exception:
                        pass
    ...
    async def purge_all(self, memory_space_id: Optional[str] = None) -> dict:
        ...
        if memory_space_id:
            ...
            try:
                spaces_result = await self.memoir.memory_spaces.list(limit=1000)
                ...
                for space in all_spaces:
                    ...
                    if space_id and any(space_id.startswith(prefix) for prefix in test_prefixes):
                        try:
                            ...
                            try:
                                await self.memoir.memory_spaces.delete(space_id)
            ...
            try:
                ...
                all_convs = await self.memoir.conversations.list(limit=1000)
            ...
            try:
                ...
                all_ctx = await self.memoir.contexts.list(limit=1000)
                ...
                for ctx in sorted_ctx:
                    ...
                    if is_test_context and ctx_id:
                        try:
                            ...
                            await self.memoir.contexts.delete(
                                ctx_id,
            ...
            try:
                ...
                all_imm = await self.memoir.immutable.list(limit=1000)
                ...
                for imm in imm_list:
                    ...
                    if is_test and imm_type and imm_id:
                        try:
                            await self.memoir.immutable.purge(imm_type, imm_id)
                            result["immutable"] += 1
                        except:
                            pass
            except Exception as e:
            ...
            try:
                ...
                all_agents = await self.memoir.agents.list(limit=1000)
                ...
                for agent in agents_list:
                    ...
                    if is_test_agent and agent_id:
                        try:
                            await self.memoir.agents.unregister(agent_id)
            ...
            try:
                ...
                mem_result = await self.memoir.client.mutation("memories:purgeAll", {})
            ...
            try:
                ...
                fact_result = await self.memoir.client.mutation("facts:purgeAll", {})
            ...
            try:
                ...
                for ns in test_namespaces:
                    try:
                        ...
                        purge_result = await self.memoir.mutable.purge_namespace(ns)
    ...
    async def verify_empty(
        ...
        try:
            # Check conversations
            convs = await self.memoir.conversations.list(
            ...
            # Check memories
            mems = await self.memoir.vector.list(
                memory_space_id=memory_space_id, limit=10
            )
            ...
            # Check facts
            fcts = await self.memoir.facts.list(
                memory_space_id=memory_space_id, limit=10
            )
            ...
            # Check immutable
            imm = await self.memoir.immutable.list(
                memory_space_id=memory_space_id, limit=10
            )
            ...
            # Check mutable
            mut = await self.memoir.mutable.list(
                memory_space_id=memory_space_id, limit=10
            )
...
class ScopedCleanup:
    ...
    Example:
        ...
        >>> cleanup = ScopedCleanup(memoir_client, ctx)
        >>>
        >>> # Create test data using ctx generators
        >>> user_id = ctx.user_id("alice")
        >>> await memoir.users.update(user_id, {"name": "Alice"})
        >>>
    ...
    def __init__(self, memoir_client: Memoir, ctx: TestRunContext, verbose: bool = False):
        """
    ...
    async def cleanup_memory_spaces(self) -> int:
        ...
        try:
            result = await self.memoir.memory_spaces.list(limit=1000)
    ...
    async def cleanup_memories(self) -> int:
        ...
        try:
            ...
            for space in spaces:
                ...
                if self._belongs_to_run(space_id):
                    try:
                        memories_result = await self.memoir.vector.list(memory_space_id=space_id, limit=1000)
                        ...
                        for mem in memories:
                            ...
                            if mem_id:
                                try:
                                    await self.memoir.vector.delete(space_id, mem_id)
                                    count += 1
                                except Exception:
                                    pass
                    except Exception:
    ...
    async def cleanup_facts(self) -> int:
        ...
        try:
            ...
            for space in spaces:
                ...
                if self._belongs_to_run(space_id):
                    try:
                        facts_result = await self.memoir.facts.list(memory_space_id=space_id, limit=1000)
                        ...
                        for fact in facts:
                            ...
                            if fact_id:
                                try:
                                    await self.memoir.facts.delete(space_id, fact_id)
                                    count += 1
                                except Exception:
                                    pass
                    except Exception:
    ...
    async def cleanup_contexts(self, timeout_per_context: float = 30.0) -> int:
        ...
        try:
            result = await self.memoir.contexts.list(limit=1000)
                ...
                if self._belongs_to_run(space_id) or self._belongs_to_run(ctx_id):
                    try:
                        ...
                        await asyncio.wait_for(
                            self.memoir.contexts.delete(ctx_id, DeleteContextOptions(cascade_children=True)),
    ...
    async def cleanup_agents(self) -> int:
        ...
        try:
            result = await self.memoir.agents.list(limit=1000)
    ...
    async def cleanup_immutable(self) -> int:
        ...
        try:
            result = await self.memoir.immutable.list(limit=1000)
            ...
            for record in records:
                ...
                if self._belongs_to_run(rec_type) or self._belongs_to_run(rec_id):
                    try:
                        await self.memoir.immutable.purge(rec_type, rec_id)
                        count += 1
                    except Exception:
                        pass
        except Exception:
    ...
    async def cleanup_mutable(self) -> int:
        ...
        try:
            result = await self.memoir.mutable.list(limit=1000)
            records = result if isinstance(result, list) else []
            ...
            for record in records:
                ...
                if self._belongs_to_run(namespace) or self._belongs_to_run(key):
                    try:
                        await self.memoir.mutable.delete(namespace, key)
                        count += 1
                    except Exception:
                        pass
        except Exception:
    ...
    async def _cleanup_all_impl(self) -> ScopedCleanupResult:
        ...
        if memory_space_ids:
            ...
            batch_deleter = BatchDeleter(self.memoir)
    ...
    async def count_remaining(self) -> Dict[str, int]:
        ...
        try:
            # Count conversations
            convs = await self.memoir.conversations.list(limit=1000)
            # Handle ListConversationsResult object or raw list/dict
            if hasattr(convs, 'conversations'):
            ...
            # Count memory spaces
            spaces = await self.memoir.memory_spaces.list(limit=1000)
            ...
            # Count contexts
            ctxs = await self.memoir.contexts.list(limit=1000)
            ...
            # Count users
            from memoir.types import ListUsersFilter
            users = await self.memoir.users.list(ListUsersFilter(limit=1000))
            # Handle ListUsersResult object or raw list/dict
            ...
            # Count agents
            agents = await self.memoir.agents.list(limit=1000)
            ...
            imm = await self.memoir.immutable.list(limit=1000)
            ...
            # Count mutable
            mut = await self.memoir.mutable.list(limit=1000)
