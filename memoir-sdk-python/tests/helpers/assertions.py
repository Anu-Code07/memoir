...
These replace conflict-prone global assertions like:
    assert await memoir.users.count() >= 3

With isolated assertions like:
    assert await count_users(memoir, ctx) == 3
"""
...
async def expect_user_count(
    memoir: Memoir, ctx: TestRunContext, expected_count: int
) -> None:
    """
    ...
    """
    count = await count_users(memoir, ctx)
    assert (
...
async def count_agents(memoir: Memoir, ctx: TestRunContext) -> int:
    """
    ...
    """
    result = await memoir.agents.list(limit=1000)
    agents = result if isinstance(result, list) else []
    return len(_filter_by_prefix(agents, ctx.run_id, ["id", "agent_id"]))


async def list_agents(memoir: Memoir, ctx: TestRunContext) -> List[Any]:
    """
...
async def count_memory_spaces(memoir: Memoir, ctx: TestRunContext) -> int:
    """
    ...
    """
    result = await memoir.memory_spaces.list(limit=1000)
...
async def list_memory_spaces(memoir: Memoir, ctx: TestRunContext) -> List[Any]:
    """
...
async def count_conversations(
    memoir: Memoir, ctx: TestRunContext, memory_space_id: Optional[str] = None
) -> int:
    """
    ...
    """
    if memory_space_id:
        result = await memoir.conversations.list(
            memory_space_id=memory_space_id, limit=1000
        )
    else:
        result = await memoir.conversations.list(limit=1000)
...
async def count_contexts(memoir: Memoir, ctx: TestRunContext) -> int:
    """
    ...
    """
    result = await memoir.contexts.list(limit=1000)
...
async def list_contexts(memoir: Memoir, ctx: TestRunContext) -> List[Any]:
    """
...
async def count_immutable(
    memoir: Memoir, ctx: TestRunContext, record_type: Optional[str] = None
) -> int:
    """
    ...
    """
    if record_type:
        result = await memoir.immutable.list(type=record_type, limit=1000)
    else:
        result = await memoir.immutable.list(limit=1000)
...
async def count_mutable(
    memoir: Memoir, ctx: TestRunContext, namespace: Optional[str] = None
) -> int:
    """
    ...
    """
    if namespace:
        result = await memoir.mutable.list(namespace=namespace, limit=1000)
    else:
        result = await memoir.mutable.list(limit=1000)
...
async def count_facts(
    memoir: Memoir, ctx: TestRunContext, memory_space_id: str
) -> int:
    """
    ...
    result = await memoir.facts.list(memory_space_id=memory_space_id, limit=1000)
...
async def count_memories(
    ...
    result = await memoir.vector.list(memory_space_id=memory_space_id, limit=1000)
...
async def retry_async(
    ...
    Example:
        result = await retry_async(
            lambda: memoir.vector.search(space_id, query="test"),
            max_retries=3,
        )
    """
    last_error = None
