...
class TestAPIResilienceIntegration:
    ...
    async def test_api_calls_flow_through_resilience_layer(self):
        ...
        # Test with FactsAPI
        from memoir.facts import FactsAPI
    ...
    async def test_resilience_layer_receives_correct_operation_names(self):
        ...
        from memoir.agents import AgentsAPI
        from memoir.conversations import ConversationsAPI
        from memoir.immutable import ImmutableAPI
        from memoir.memory_spaces import MemorySpacesAPI
        from memoir.mutable import MutableAPI
        from memoir.vector import VectorAPI
    ...
    async def test_streaming_handlers_support_resilience(self):
        ...
        from memoir.memory.streaming.error_recovery import StreamErrorRecovery
        from memoir.memory.streaming.progressive_storage_handler import (
