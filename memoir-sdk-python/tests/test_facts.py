...
from memoir import FactSourceRef, StoreFactParams
...
@pytest.mark.asyncio
async def test_store_preference_fact(memoir_client, test_ids, cleanup_helper):
    """
    ...
    fact = await memoir_client.facts.store(
        StoreFactParams(
...
@pytest.mark.asyncio
async def test_store_knowledge_fact_with_source_ref(memoir_client, test_ids, cleanup_helper):
    """
...
@pytest.mark.asyncio
async def test_store_relationship_fact(memoir_client, test_ids, cleanup_helper):
    """
...
@pytest.mark.asyncio
async def test_store_fact_with_enrichment_fields(memoir_client, test_ids, cleanup_helper):
    """
    Test storing a fact with enrichment fields.

    Validates TypeScript SDK 0.21.0 parity for enrichment field support.
    """
    from memoir.types import EnrichedEntity, EnrichedRelation
...
@pytest.mark.asyncio
async def test_store_fact_with_embedding(memoir_client, test_ids, cleanup_helper):
    """
...
@pytest.mark.asyncio
async def test_get_fact_by_id(memoir_client, test_ids, cleanup_helper):
    """
    ...
    # Create fact
    stored = await memoir_client.facts.store(
        StoreFactParams(
            memory_space_id=memory_space_id,
            fact="Test fact",
    ...
    # Get fact
    retrieved = await memoir_client.facts.get(memory_space_id, fact_id)
...
@pytest.mark.asyncio
async def test_get_nonexistent_fact_returns_none(memoir_client, test_ids):
    """
    ...
    result = await memoir_client.facts.get(memory_space_id, "fact-does-not-exist")
...
@pytest.mark.asyncio
async def test_list_facts(memoir_client, test_ids, cleanup_helper):
    """
    ...
    for i in range(3):
        await memoir_client.facts.store(
            StoreFactParams(
                memory_space_id=memory_space_id,
    ...
    result = await memoir_client.facts.list(
...
@pytest.mark.asyncio
async def test_list_facts_filter_by_type(memoir_client, test_ids, cleanup_helper):
    """
...
@pytest.mark.asyncio
async def test_search_facts(memoir_client, test_ids, cleanup_helper):
    """
    ...
    results = await memoir_client.facts.search(memory_space_id, "dark mode")
...
@pytest.mark.asyncio
async def test_semantic_search_facts(memoir_client, test_ids, cleanup_helper):
    """
    Test semantic (vector) search on facts using embeddings.

    Validates v0.30.0+ semantic_search() method.
    """
    from memoir.types import SemanticSearchFactsOptions
    from tests.helpers.embeddings import generate_mock_embedding
    ...
    fact1 = await memoir_client.facts.store(
        StoreFactParams(
            memory_space_id=memory_space_id,
            fact=fact1_text,
            fact_type="preference",
    ...
    fact2 = await memoir_client.facts.store(
        StoreFactParams(
            memory_space_id=memory_space_id,
            fact=fact2_text,
            fact_type="preference",
    ...
    fact3 = await memoir_client.facts.store(
        StoreFactParams(
            memory_space_id=memory_space_id,
            fact=fact3_text,
            fact_type="knowledge",
    ...
    results = await retry_async(
        lambda: memoir_client.facts.semantic_search(
            memory_space_id,
            query_embedding,
...
@pytest.mark.asyncio
async def test_semantic_search_with_filters(memoir_client, test_ids, cleanup_helper):
    """
...
@pytest.mark.asyncio
async def test_update_fact_confidence(memoir_client, test_ids, cleanup_helper):
    """
    ...
    # Update confidence
    updated = await memoir_client.facts.update(
        memory_space_id,
        fact_id,
        {"confidence": 95},
    )
...
@pytest.mark.asyncio
async def test_update_fact_with_update_fact_input(memoir_client, test_ids, cleanup_helper):
    """
    Test updating fact using UpdateFactInput dataclass.

    Validates TypeScript SDK 0.21.0 parity for typed update input.
    """
    from memoir.types import UpdateFactInput
...
@pytest.mark.asyncio
async def test_update_fact_with_enrichment_fields_dict(memoir_client, test_ids, cleanup_helper):
    """
...
@pytest.mark.asyncio
async def test_update_fact_with_embedding(memoir_client, test_ids, cleanup_helper):
    """
...
@pytest.mark.asyncio
async def test_get_fact_with_embedding(memoir_client, test_ids, cleanup_helper):
    """
...
@pytest.mark.asyncio
async def test_delete_fact(memoir_client, test_ids, cleanup_helper):
    """
    ...
    # Delete fact
    result = await memoir_client.facts.delete(memory_space_id, fact_id)
...
@pytest.mark.asyncio
async def test_delete_fact_returns_typed_result(memoir_client, test_ids, cleanup_helper):
    """
    Test that delete() returns typed DeleteFactResult.

    Validates TypeScript SDK 0.21.0 parity for typed return types.
    """
    from memoir.types import DeleteFactResult
...
@pytest.mark.asyncio
async def test_delete_many_returns_typed_result(memoir_client, test_ids, cleanup_helper):
    """
    Test that delete_many() returns typed DeleteManyFactsResult.

    Validates TypeScript SDK 0.21.0 parity for typed return types.
    """
    from memoir.types import DeleteManyFactsParams, DeleteManyFactsResult
    ...
    result = await memoir_client.facts.delete_many(
...
@pytest.mark.asyncio
async def test_count_facts(memoir_client, test_ids, cleanup_helper):
    """
    ...
    # Count facts
    from memoir.types import CountFactsFilter
    count = await memoir_client.facts.count(
...
class TestStoreValidation:
    ...
    @pytest.mark.asyncio
    async def test_missing_memory_space_id(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_empty_fact(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_invalid_fact_type(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_confidence_below_zero(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_confidence_above_100(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_invalid_source_type(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_invalid_tags_not_list(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_invalid_validity_period(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_invalid_source_ref_structure(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_invalid_metadata_not_dict(self, memoir_client):
        from memoir.facts import FactsValidationError
...
class TestGetValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.get("", "fact-123")
        assert "memory_space_id is required" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_missing_fact_id(self, memoir_client):
        from memoir.facts import FactsValidationError

        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.get("test-space", "")
        assert "fact_id is required" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_invalid_fact_id_format(self, memoir_client):
        from memoir.facts import FactsValidationError

        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.get("test-space", "invalid-id")
...
class TestListValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.list(
    ...
    @pytest.mark.asyncio
    async def test_invalid_confidence(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import ListFactsFilter
    ...
    @pytest.mark.asyncio
    async def test_invalid_min_confidence(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import ListFactsFilter
    ...
    @pytest.mark.asyncio
    async def test_invalid_tag_match(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import ListFactsFilter
    ...
    @pytest.mark.asyncio
    async def test_negative_limit(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import ListFactsFilter
    ...
    @pytest.mark.asyncio
    async def test_negative_offset(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import ListFactsFilter
    ...
    @pytest.mark.asyncio
    async def test_invalid_date_range_created(self, memoir_client):
    ...
    @pytest.mark.asyncio
    async def test_invalid_date_range_updated(self, memoir_client):
        from datetime import datetime, timedelta
...
class TestCountValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.count(
...
class TestSearchValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.search("", "test query")
        assert "memory_space_id is required" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_missing_query(self, memoir_client):
        from memoir.facts import FactsValidationError

        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.search("test-space", "")
        assert "query is required" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_invalid_options(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import SearchFactsOptions

        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.search(
                "test-space",
                "test",
...
class TestSemanticSearchValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.semantic_search("", embedding)
        assert "memory_space_id is required" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_empty_embedding(self, memoir_client):
        from memoir.facts import FactsValidationError

        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.semantic_search("test-space", [])
        assert "Embedding vector is required" in str(exc_info.value)
        assert exc_info.value.code == "INVALID_EMBEDDING"

    @pytest.mark.asyncio
    async def test_none_embedding(self, memoir_client):
        from memoir.facts import FactsValidationError

        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.semantic_search("test-space", None)
        assert "Embedding vector is required" in str(exc_info.value)
    ...
    async def test_invalid_min_confidence(self, memoir_client):
        ...
        embedding = generate_mock_embedding("test query")
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.semantic_search(
                "test-space",
                embedding,
    ...
    @pytest.mark.asyncio
    async def test_invalid_tags(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import SemanticSearchFactsOptions
        from tests.helpers.embeddings import generate_mock_embedding
...
class TestUpdateValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.update("", "fact-123", {"confidence": 95})
        assert "memory_space_id is required" in str(exc_info.value)
    ...
    async def test_missing_fact_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.update("test-space", "", {"confidence": 95})
        assert "fact_id is required" in str(exc_info.value)
    ...
    async def test_invalid_fact_id_format(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.update(
                "test-space",
                "invalid-id",
                {"confidence": 95}
            )
    ...
    @pytest.mark.asyncio
    async def test_empty_updates_object(self, memoir_client):
        from memoir.facts import FactsValidationError

        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.update("test-space", "fact-123", {})
        assert "Update must include at least one field" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_invalid_confidence_in_updates(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_invalid_tags_in_updates(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_invalid_metadata_in_updates(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    def test_enrichment_field_category_accepted(self):
        ...
        """
        from memoir.facts.validators import validate_update_has_fields
...
class TestDeleteValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.delete("", "fact-123")
        assert "memory_space_id is required" in str(exc_info.value)
    ...
    async def test_missing_fact_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.delete("test-space", "")
        assert "fact_id is required" in str(exc_info.value)
    ...
    async def test_invalid_fact_id_format(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.delete("test-space", "invalid-id")
        assert 'fact_id must start with "fact-"' in str(exc_info.value)
...
class TestGetHistoryValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.get_history("", "fact-123")
        assert "memory_space_id is required" in str(exc_info.value)
    ...
    async def test_missing_fact_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.get_history("test-space", "")
        assert "fact_id is required" in str(exc_info.value)
    ...
    async def test_invalid_fact_id_format(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.get_history("test-space", "invalid-id")
        assert 'fact_id must start with "fact-"' in str(exc_info.value)
...
class TestQueryBySubjectValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import QueryBySubjectFilter

        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.query_by_subject(
    ...
    @pytest.mark.asyncio
    async def test_missing_subject(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import QueryBySubjectFilter
...
class TestQueryByRelationshipValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import QueryByRelationshipFilter

        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.query_by_relationship(
    ...
    @pytest.mark.asyncio
    async def test_missing_predicate(self, memoir_client):
        from memoir.facts import FactsValidationError
        from memoir.types import QueryByRelationshipFilter
...
class TestExportValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.export("", format="json")
        assert "memory_space_id is required" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_invalid_format(self, memoir_client):
        from memoir.facts import FactsValidationError

        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.export("test-space", format="xml")
    ...
    async def test_invalid_fact_type(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.export(
                "test-space",
                format="json",
                fact_type="invalid"
            )
...
class TestConsolidateValidation:
    ...
    async def test_missing_memory_space_id(self, memoir_client):
        ...
        with pytest.raises(FactsValidationError) as exc_info:
            await memoir_client.facts.consolidate(
                "",
                ["fact-1", "fact-2"],
                "fact-1"
            )
    ...
    @pytest.mark.asyncio
    async def test_empty_fact_ids_array(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_fact_ids_with_single_element(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_missing_keep_fact_id(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_keep_fact_id_not_in_fact_ids(self, memoir_client):
        from memoir.facts import FactsValidationError
    ...
    @pytest.mark.asyncio
    async def test_duplicate_fact_ids(self, memoir_client):
        from memoir.facts import FactsValidationError
...
class TestSupersedeValidation:
    ...
    @pytest.mark.asyncio
    async def test_self_supersession_raises_error(self, memoir_client, test_ids, cleanup_helper):
        """
        ...
        with pytest.raises(ValueError) as exc_info:
            await memoir_client.facts.supersede(
                memory_space_id=memory_space_id,
                old_fact_id=fact_id,
