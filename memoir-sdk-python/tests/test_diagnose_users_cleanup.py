...
@pytest.mark.asyncio
async def test_diagnose_users_list(memoir_client):
    ...
    await memoir_client.users.update(user_id, {"name": "Diagnostic Test User"})
    ...
    print("\n3. Listing users...")
    try:
        result = await memoir_client.users.list(limit=1000)
    ...
    try:
        ...
        if count == 0:
            ...
            result2 = await memoir_client.users.list(limit=1000)
    ...
    memoir_client.get_resilience().reset()
