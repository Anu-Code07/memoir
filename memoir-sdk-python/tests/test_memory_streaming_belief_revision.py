...
class TestEnhancedRememberStreamResultFactRevisions:
    ...
    def test_result_has_fact_revisions_field(self) -> None:
        ...
        from memoir.memory.streaming_types import (
            EnhancedRememberStreamResult,
            PerformanceInsights,
            ProgressiveProcessing,
            StreamMetrics,
        )
        from memoir.types import FactRecord, MemoryEntry
    ...
    def test_result_fact_revisions_can_be_list(self) -> None:
        ...
        from memoir.types import FactRecord, FactRevisionAction
...
class TestRememberStreamBeliefRevisionIntegration:
    ...
    async def test_remember_stream_passes_belief_revision_false(
        ...
        from memoir.memory.streaming_types import StreamingOptions
        from memoir.types import MemoirConfig, RememberStreamParams
    ...
    async def test_remember_stream_with_llm_has_fact_revisions(
        ...
        from memoir import Memoir
        from memoir.memory.streaming_types import StreamingOptions
        from memoir.types import MemoirConfig, LLMConfig
...
class TestStreamingBeliefRevisionE2E:
    ...
    async def test_e2e_add_fact_via_streaming(self, ctx: TestRunContext) -> None:
        ...
        try:
            ...
            if memoir.facts.has_belief_revision() and result.fact_revisions:
    ...
    async def test_e2e_supersede_fact_via_streaming(
        ...
        try:
            ...
            await memoir.memory.remember_stream(
                {
                    "memorySpaceId": memory_space_id,
            ...
            result2 = await memoir.memory.remember_stream(
                {
                    "memorySpaceId": memory_space_id,
            ...
            if memoir.facts.has_belief_revision() and result2.fact_revisions:
