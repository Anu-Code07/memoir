"""
Tests for Configuration Module (memoir.config)
...
def test_get_recall_defaults_respects_env_vars():
    ...
    original_env = {}
    env_vars = {
        "MEMOIR_RECALL_LIMIT_MEMORIES": "50",
        "MEMOIR_RECALL_LIMIT_FACTS": "25",
        "MEMOIR_RECALL_GRAPH_HOPS": "3",
        "MEMOIR_RECALL_GRAPH_ENTITIES_PER_HOP": "10",
        "MEMOIR_RECALL_GRAPH_RESULTS_PER_ENTITY": "5",
        "MEMOIR_RECALL_LIMIT_TOTAL": "40",
    }
...
def test_get_recall_defaults_handles_invalid_env_vars():
    ...
    os.environ["MEMOIR_RECALL_LIMIT_MEMORIES"] = "invalid"
    os.environ["MEMOIR_RECALL_LIMIT_FACTS"] = "not-a-number"
    ...
    try:
        ...
        # Clean up
        os.environ.pop("MEMOIR_RECALL_LIMIT_MEMORIES", None)
        os.environ.pop("MEMOIR_RECALL_LIMIT_FACTS", None)
...
def test_resolve_recall_limits_env_var_integration():
    ...
    # Set env vars
    os.environ["MEMOIR_RECALL_LIMIT_MEMORIES"] = "60"
    os.environ["MEMOIR_RECALL_LIMIT_TOTAL"] = "45"
    ...
    try:
        ...
        # Clean up
        os.environ.pop("MEMOIR_RECALL_LIMIT_MEMORIES", None)
        os.environ.pop("MEMOIR_RECALL_LIMIT_TOTAL", None)


def test_resolve_recall_limits_user_overrides_env_vars():
    """resolve_recall_limits() user limits take precedence over env vars."""
    # Set env vars
    os.environ["MEMOIR_RECALL_LIMIT_MEMORIES"] = "100"
    os.environ["MEMOIR_RECALL_LIMIT_TOTAL"] = "80"
