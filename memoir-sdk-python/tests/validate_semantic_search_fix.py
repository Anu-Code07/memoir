...
async def validate_semantic_search_fix():
    ...
    print("Avoid: Agent responses like 'I've noted your email address'\n")
    ...
    if fix_valid and role_correct:
        ...
        print("   • Role-based weighting is working consistently")
    else:
    ...
    try:
        ...
        from memoir.types import DeleteMemorySpaceOptions
        await memoir.memory_spaces.delete(memory_space_id, DeleteMemorySpaceOptions())
