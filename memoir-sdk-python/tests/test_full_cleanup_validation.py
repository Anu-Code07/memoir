...
@pytest.mark.asyncio
async def test_full_cleanup_validation(memoir_client, ctx):
    """
    ...
    for i in range(3):
        ...
        await memoir_client.users.update(uid, {"name": f"Test User {i+1}"})
    ...
    # List conversations
    convs_result = await memoir_client.conversations.list(memory_space_id=memory_space_id, limit=100)
    ...
    # Count memories
    mem_list = await memoir_client.vector.list(memory_space_id=memory_space_id, limit=100)
    ...
    user_list = await memoir_client.users.list(ListUsersFilter(limit=1000))
    ...
    # Check conversations
    conv_count_after = await memoir_client.conversations.count(memory_space_id=memory_space_id)
    ...
    # Check memories
    mem_list_after = await memoir_client.vector.list(memory_space_id=memory_space_id, limit=100)
    ...
    user_list_after = await memoir_client.users.list(ListUsersFilter(limit=1000))
