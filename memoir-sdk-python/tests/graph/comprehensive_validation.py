...
Tests ALL Memoir APIs that interact with graph to ensure actual data sync.
...
from memoir import MemoirClient
...
async def main():
    ...
    client = MemoirClient(CONVEX_URL, graph_adapter=graph_adapter)
