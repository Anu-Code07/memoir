...
from memoir.types import GraphConnectionConfig, GraphEdge, GraphNode

NEO4J_CONFIG = GraphConnectionConfig(
    uri=os.getenv("NEO4J_URI", "bolt://localhost:7687"),
    username=os.getenv("NEO4J_USERNAME", "neo4j"),
    password=os.getenv("NEO4J_PASSWORD", "memoir-dev-password"),
)
...
MEMGRAPH_CONFIG = GraphConnectionConfig(
    ...
    password=os.getenv("MEMGRAPH_PASSWORD", "memoir-dev-password"),
)
