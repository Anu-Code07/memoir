...
async def param_test_setup(module_memoir_client, test_run_context):
    ...
    conv = await module_memoir_client.conversations.create(
        CreateConversationInput(
            type="user-agent",
...
@pytest.mark.asyncio
async def test_propagates_participant_id_to_vector_layer(memoir_client, param_test_setup):
    """
    ...
    user_mem = await memoir_client.vector.get(setup["memory_space_id"], result.memories[0].memory_id)
    ...
    agent_mem = await memoir_client.vector.get(setup["memory_space_id"], result.memories[1].memory_id)
...
@pytest.mark.asyncio
async def test_propagates_importance_to_vector_layer(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_propagates_tags_to_vector_layer(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_propagates_user_id_to_vector_layer(memoir_client, param_test_setup):
    """
    ...
    for mem in result.memories:
        stored = await memoir_client.vector.get(setup["memory_space_id"], mem.memory_id)
...
@pytest.mark.asyncio
async def test_propagates_participant_id_to_conversation_messages(memoir_client, param_test_setup):
    """
    ...
    conv = await memoir_client.conversations.get(result.conversation["conversationId"])
...
@pytest.mark.asyncio
async def test_propagates_participant_id_to_extracted_facts(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_propagates_none_for_optional_participant_id(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_propagates_default_importance_when_omitted(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_user_id_propagates_through_all_layers(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_memory_space_id_consistent_across_layers(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_propagates_custom_metadata_fields(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_propagates_source_user_name_to_memories(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_propagates_conversation_id_to_conversation_ref(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_auto_generates_timestamp_when_omitted(memoir_client, param_test_setup):
    """
...
@pytest.mark.asyncio
async def test_propagates_all_parameters_together(memoir_client, param_test_setup):
    """
