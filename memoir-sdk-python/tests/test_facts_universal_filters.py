...
class TestFactsUniversalFilters:
    ...
    # Use the memoir_client fixture from conftest.py (no need to override)
    ...
    @pytest.mark.asyncio
    async def test_list_filter_by_user_id(self, memoir_client, test_space_id):
    ...
    @pytest.mark.asyncio
    async def test_list_filter_by_participant_id(self, memoir_client, test_space_id):
    ...
    @pytest.mark.asyncio
    async def test_count_filter_by_user_id(self, memoir_client, test_space_id):
    ...
    @pytest.mark.asyncio
    async def test_list_filter_by_created_after(self, memoir_client, test_space_id):
        ...
        recent_fact = await memoir_client.facts.store(
            StoreFactParams(
                memory_space_id=space_id,
                fact="Recent fact",
                fact_type="knowledge",
    ...
    @pytest.mark.asyncio
    async def test_search_combine_date_filters(self, memoir_client, test_space_id):
    ...
    async def test_list_filter_by_source_type(
        self, memoir_client, test_space_id, source_type
    ):
    ...
    @pytest.mark.asyncio
    async def test_list_filter_by_tags_any_match(self, memoir_client, test_space_id):
    ...
    @pytest.mark.asyncio
    async def test_list_filter_by_tags_all_match(self, memoir_client, test_space_id):
    ...
    @pytest.mark.asyncio
    async def test_list_filter_by_min_confidence(self, memoir_client, test_space_id):
    ...
    @pytest.mark.asyncio
    async def test_search_filter_by_min_confidence(self, memoir_client, test_space_id):
    ...
    @pytest.mark.asyncio
    async def test_list_filter_by_metadata(self, memoir_client, test_space_id):
    ...
    @pytest.mark.asyncio
    async def test_list_sort_by_confidence(self, memoir_client, test_space_id):
    ...
    @pytest.mark.asyncio
    async def test_list_pagination(self, memoir_client, test_space_id):
        ...
        page1 = await memoir_client.facts.list(
            ListFactsFilter(
                memory_space_id=space_id,
                limit=2,
                offset=0,
        ...
        page2 = await memoir_client.facts.list(
            ListFactsFilter(
                memory_space_id=space_id,
                limit=2,
                offset=2,
    ...
    async def test_combine_multiple_universal_filters(
        self, memoir_client, test_space_id
    ):
    ...
    @pytest.mark.asyncio
    async def test_search_with_complex_filters(self, memoir_client, test_space_id):
