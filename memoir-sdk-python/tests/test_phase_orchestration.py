...
@pytest.mark.asyncio
async def test_full_flow_recall_then_remember(memoir_client, ctx):
    ...
    recall_result = await memoir_client.memory.recall(
        RecallParams(
    ...
    remember_result = await memoir_client.memory.remember(
        RememberParams(
            memory_space_id=memory_space_id,
...
@pytest.mark.asyncio
async def test_recall_event_ordering_start_layers_complete(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_event_ordering_start_layers_complete(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_timing_values_are_reasonable(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_timing_values_are_reasonable(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_layers_include_context(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_layers_include_core_layers(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_same_observer_for_both_phases(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_summary_context_counts_match_results(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_orchestration_ids_are_unique(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_and_remember_ids_have_different_prefixes(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_layer_events_include_data_on_complete(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_layer_status_progression(memoir_client, ctx):
