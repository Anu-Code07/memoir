...
@pytest.mark.asyncio
async def test_recall_vector_layer_event_has_recall_phase(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_facts_layer_event_has_recall_phase(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_graph_layer_event_has_recall_phase(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_context_layer_event_has_recall_phase(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_observer_on_recall_complete_called_with_summary(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_observer_error_does_not_fail_recall(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_all_events_have_recall_phase(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_recall_event_sequence_order(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_observer_on_remember_start_called(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_all_layer_events_have_remember_phase(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_observer_on_remember_complete_called(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_works_without_observer(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_vector_layer_event_has_remember_phase(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_conversation_layer_event_has_remember_phase(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_observer_error_does_not_fail_remember(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_created_ids_in_summary(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_remember_layer_latency_tracking(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_observer_with_partial_implementation(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_observer_receives_skipped_status_for_disabled_layers(memoir_client, ctx):
...
@pytest.mark.asyncio
async def test_observer_error_status_for_failed_layers(memoir_client, ctx):
