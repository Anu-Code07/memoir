...
class TestMemorySpacesTypeFilterParametrized:
    ...
    @pytest.mark.asyncio
    async def test_list_filters_by_type(self, memoir_client, space_type):
        """Test memory_spaces.list() filters correctly by type."""
        # Register space with target type
        space_id = generate_test_memory_space_id()
        _target_space = await memoir_client.memory_spaces.register(
        ...
        results = await memoir_client.memory_spaces.list(type=space_type)
...
class TestMemorySpacesStatusFilterParametrized:
    ...
    @pytest.mark.asyncio
    async def test_list_filters_by_status(self, memoir_client, status):
        ...
        results = await memoir_client.memory_spaces.list(status=status)
...
class TestMemorySpacesFilterEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_list_filter_no_matches_type(self, memoir_client):
        ...
        results = await memoir_client.memory_spaces.list(type="team")
    ...
    @pytest.mark.asyncio
    async def test_combine_type_and_status_filters(self, memoir_client):
        ...
        await memoir_client.memory_spaces.archive(archived_team_id)

        # Execute: Filter by type AND status
        results = await memoir_client.memory_spaces.list(type="team", status="active")
    ...
    @pytest.mark.asyncio
    async def test_all_space_types_coexist(self, memoir_client):
    ...
    @pytest.mark.asyncio
    async def test_status_transition_active_to_archived(self, memoir_client):
        """Test status change from active to archived."""
        # Register active space
        space_id = generate_test_memory_space_id()
        _space = await memoir_client.memory_spaces.register(
            RegisterMemorySpaceParams(
                memory_space_id=space_id,
                type="project",
        ...
        active_results = await memoir_client.memory_spaces.list(status="active")
        ...
        archived_results = await memoir_client.memory_spaces.list(status="archived")
        ...
        active_results_after = await memoir_client.memory_spaces.list(status="active")
    ...
    @pytest.mark.asyncio
    async def test_list_filter_multiple_results_by_type(self, memoir_client):
        ...
        results = await memoir_client.memory_spaces.list(type="custom")
    ...
    @pytest.mark.asyncio
    async def test_list_no_filter_returns_all(self, memoir_client):
        ...
        # List all (no filters)
        all_results = await memoir_client.memory_spaces.list()
    ...
    @pytest.mark.asyncio
    async def test_archived_filter_excludes_active(self, memoir_client):
        ...
        await memoir_client.memory_spaces.archive(archived_id)
    ...
    @pytest.mark.asyncio
    async def test_combine_filters_different_types_same_status(self, memoir_client):
        ...
        personal_results = await memoir_client.memory_spaces.list(
        ...
        team_results = await memoir_client.memory_spaces.list(
