...
class TestMemoryRememberBeliefRevisionE2E:
    ...
    async def test_remember_with_belief_revision_disabled(
        ...
        from memoir.types import MemoirConfig, RememberOptions, RememberParams

        # Initialize Memoir with config
    ...
    async def test_remember_graceful_fallback_without_llm(
        ...
        """
        from memoir import Memoir
        from memoir.types import MemoirConfig, RememberParams

        convex_url = os.environ.get("CONVEX_URL")

        # Create Memoir without LLM
        memoir = Memoir(MemoirConfig(convex_url=convex_url))
    ...
    async def test_remember_with_auto_configured_llm(
        ...
        """
        from memoir import Memoir
        from memoir.types import MemoirConfig, LLMConfig, RememberParams
        ...
        memoir = Memoir(MemoirConfig(convex_url=convex_url, llm=llm_config))
...
class TestRememberResultFactRevisions:
    ...
    async def test_fact_revisions_structure(self, memory_space_id, user_id):
        ...
        """
        from memoir.types import FactRevisionAction, RememberResult, FactRecord
    ...
    async def test_fact_revisions_all_action_types(self, memory_space_id):
        ...
        from memoir.types import FactRevisionAction, FactRecord
