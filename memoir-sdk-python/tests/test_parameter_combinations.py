...
class TestVectorStoreParameterCombinations:
    ...
    async def test_all_parameters_provided(self, memoir_client):
    ...
    async def test_minimal_parameters(self, memoir_client):
...
class TestFactsStoreParameterCombinations:
    ...
    async def test_all_parameters_provided(self, memoir_client):
        ...
        result = await memoir_client.facts.store(
            StoreFactParams(
                memory_space_id=space_id,
...
class TestParameterPreservation:
    ...
    async def test_vector_update_preserves_participant_id(self, memoir_client):
