"""
Memoir SDK - Type Definitions

Complete type system for all Memoir operations, matching the TypeScript SDK.
"""
...
class RecallResult:
    ...
    Example:
        >>> result = await memoir.memory.recall(params)
...
class AuthContext:
    ...
    Example:
        ...
        >>> await memoir.memory.remember(...)  # user_id, tenant_id auto-injected
    """
    # Required
    user_id: str
