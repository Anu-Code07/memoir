...
class ContextsAPI:
    ...
    async def get(
        ...
        Example:
            >>> chain = await memoir.contexts.get(
            ...     'ctx-abc123',
            ...     include_chain=True
            ... )
        """
    ...
    async def delete(
        ...
        Example:
            >>> result = await memoir.contexts.delete(
            ...     'ctx-root',
    ...
    async def search(
        ...
        Example:
            >>> active = await memoir.contexts.search(
            ...     ListContextsFilter(
            ...         user_id='user-123',
            ...         status='active',
            ...     )
    ...
    async def list(
        ...
        *,
        ...
        Example:
            >>> # Using filter object
            >>> contexts = await memoir.contexts.list(
            ...     ListContextsFilter(
    ...
    async def count(
        ...
        *,
        ...
        Example:
            >>> # Using filter object
            >>> total = await memoir.contexts.count(
            ...     CountContextsFilter(
    ...
    async def get_chain(self, context_id: str) -> Dict[str, Any]:
        ...
        Example:
            >>> chain = await memoir.contexts.get_chain('ctx-child')
        """
        # Client-side validation
        validate_required_string(context_id, "context_id")
        validate_context_id_format(context_id)
    ...
    async def grant_access(
        ...
        Example:
            >>> await memoir.contexts.grant_access(
            ...     'ctx-abc123',
            ...     'partner-space',
            ...     'collaborate'
            ... )
    ...
    async def get_root(self, context_id: str) -> Context:
        ...
        Example:
            >>> root = await memoir.contexts.get_root('ctx-deeply-nested-child')
        """
        # Client-side validation
        validate_required_string(context_id, "context_id")
        validate_context_id_format(context_id)
    ...
    async def get_children(
        ...
        Example:
            >>> children = await memoir.contexts.get_children('ctx-root')
        """
        # Client-side validation
        validate_required_string(context_id, "context_id")
        validate_context_id_format(context_id)
    ...
    async def find_orphaned(self) -> List[Context]:
        ...
        Example:
            >>> orphaned = await memoir.contexts.find_orphaned()
        """
        result = await self._execute_with_resilience(
    ...
    async def add_participant(self, context_id: str, participant_id: str) -> Context:
        ...
        Example:
            >>> await memoir.contexts.add_participant('ctx-abc123', 'legal-agent')
        """
        # Client-side validation
        validate_required_string(context_id, "context_id")
        validate_context_id_format(context_id)
    ...
    async def remove_participant(self, context_id: str, participant_id: str) -> Context:
        ...
        Example:
            >>> await memoir.contexts.remove_participant('ctx-abc123', 'old-agent')
        """
        # Client-side validation
        validate_required_string(context_id, "context_id")
        validate_context_id_format(context_id)
    ...
    async def get_by_conversation(self, conversation_id: str) -> List[Context]:
        ...
        Example:
            >>> contexts = await memoir.contexts.get_by_conversation('conv-456')
        """
        # Client-side validation
    ...
    async def update_many(
        ...
        Example:
            >>> await memoir.contexts.update_many(
            ...     {'status': 'completed'},
            ...     {'data': {'archived': True}}
            ... )
        """
    ...
    async def delete_many(
        ...
        Example:
            >>> result = await memoir.contexts.delete_many(
            ...     {'status': 'cancelled'},
    ...
    async def get_version(
        ...
        Example:
            >>> v1 = await memoir.contexts.get_version('ctx-abc123', 1)
        """
        # Client-side validation
        validate_required_string(context_id, "context_id")
        validate_context_id_format(context_id)
    ...
    async def get_history(self, context_id: str) -> List[Dict[str, Any]]:
        ...
        Example:
            >>> history = await memoir.contexts.get_history('ctx-abc123')
        """
        # Client-side validation
        validate_required_string(context_id, "context_id")
        validate_context_id_format(context_id)
    ...
    async def get_at_timestamp(
        ...
        Example:
            >>> historical = await memoir.contexts.get_at_timestamp(
