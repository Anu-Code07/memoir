...
class SessionsAPI:
    ...
    async def get(self, session_id: str) -> Optional[Session]:
        ...
        Example:
            >>> session = await memoir.sessions.get('sess-123')
    ...
    async def get_or_create(
        ...
        Example:
            >>> session = await memoir.sessions.get_or_create(
            ...     'user-123',
    ...
    async def end_all(
        ...
        Example:
            >>> result = await memoir.sessions.end_all('user-123')
    ...
    async def list(self, filters: Optional[SessionFilters] = None) -> List[Session]:
        ...
        Example:
            ...
            >>> sessions = await memoir.sessions.list(SessionFilters(
            ...     user_id='user-123',
            ...     status='active',
            ... ))
        """
    ...
    async def count(self, filters: Optional[SessionFilters] = None) -> int:
        ...
        Example:
            >>> active_count = await memoir.sessions.count(SessionFilters(
            ...     user_id='user-123',
            ...     status='active',
            ... ))
        """
    ...
    async def expire_idle(
        ...
        Example:
            ...
            >>> result = await memoir.sessions.expire_idle(
