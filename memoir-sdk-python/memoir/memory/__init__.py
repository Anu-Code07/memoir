"""
Memoir SDK - Memory Convenience API
...
from ..errors import MemoirError, ErrorCode
...
class MemoryAPI:
    ...
    def _notify_layer_update(
        ...
        try:
            ...
            print(f"[Memoir] Observer on_layer_update failed: {e}")
    ...
    def _notify_remember_start(
        ...
        try:
            ...
            print(f"[Memoir] Observer on_remember_start failed: {e}")
    ...
    def _notify_remember_complete(
        ...
        try:
            ...
            print(f"[Memoir] Observer on_remember_complete failed: {e}")
    ...
    def _notify_recall_start(
        ...
        try:
            ...
            print(f"[Memoir] Observer on_recall_start failed: {e}")
    ...
    def _notify_recall_complete(
        ...
        try:
            ...
            print(f"[Memoir] Observer on_recall_complete failed: {e}")
    ...
    async def _create_llm_fact_extractor(
        ...
        try:
            ...
            print(f"[Memoir] LLM fact extraction failed: {e}")
            return None
    ...
    async def remember_stream(
        ...
        Example:
            >>> # Basic usage
            >>> result = await memoir.memory.remember_stream({
    ...
    async def forget(
        ...
        Example:
            >>> result = await memoir.memory.forget(
            ...     'agent-1', 'mem-123',
        ...
        if not memory:
            raise MemoirError(ErrorCode.MEMORY_NOT_FOUND, f"Memory {memory_id} not found")
    ...
    async def get(
        ...
        Example:
            >>> enriched = await memoir.memory.get(
            ...     'agent-1', 'mem-123',
    ...
    async def recall(
        ...
        Example:
            ...
            >>> result = await memoir.memory.recall(
            ...     RecallParams(
        ...
        if search_vector and limits.memories > 0:
            ...
            try:
                ...
                print(f"[Memoir] Vector search failed: {e}")
                if observer:
                    event = self._create_layer_event(
        ...
        if search_facts and limits.facts > 0:
            ...
            try:
                ...
                print(f"[Memoir] Facts search failed: {e}")
                if observer:
                    event = self._create_layer_event(
        ...
        if graph_expansion_enabled and search_graph and self.graph_adapter:
            ...
            try:
                ...
                print(f"[Memoir] Graph expansion failed: {e}")
                if observer:
                    event = self._create_layer_event(
    ...
    async def store(
        ...
        Example:
            >>> result = await memoir.memory.store(
            ...     'agent-1',
            ...     StoreMemoryInput(
    ...
    async def update(
        ...
        Example:
            >>> result = await memoir.memory.update(
            ...     'agent-1', 'mem-123',
    ...
    async def delete(
        ...
        Example:
            >>> result = await memoir.memory.delete('agent-1', 'mem-123')
        """
        # Client-side validation
        validate_memory_space_id(memory_space_id)
        validate_memory_id(memory_id)
    ...
    async def update_many(
        ...
        Example:
            >>> result = await memoir.memory.update_many(
            ...     'agent-1',
            ...     {'user_id': 'user-123'},
            ...     {'importance': 80}
            ... )
    ...
    async def delete_many(
        ...
        Example:
            >>> result = await memoir.memory.delete_many(
            ...     'agent-1',
            ...     {'user_id': 'user-123'}
            ... )
        """
    ...
    async def archive(
        ...
        Example:
            >>> result = await memoir.memory.archive('agent-1', 'mem-123')
        """
        # Client-side validation
        validate_memory_space_id(memory_space_id)
        validate_memory_id(memory_id)
    ...
    async def restore_from_archive(
        ...
        Example:
            >>> restored = await memoir.memory.restore_from_archive('agent-1', 'mem-123')
    ...
    async def get_version(
        ...
        Example:
            >>> version = await memoir.memory.get_version('agent-1', 'mem-123', 1)
        """
        # Client-side validation
        validate_memory_space_id(memory_space_id)
        validate_memory_id(memory_id)
    ...
    async def get_history(
        ...
        Example:
            >>> history = await memoir.memory.get_history('agent-1', 'mem-123')
        """
        # Client-side validation
        validate_memory_space_id(memory_space_id)
        validate_memory_id(memory_id)
    ...
    async def get_at_timestamp(
        ...
        Example:
            >>> version = await memoir.memory.get_at_timestamp('agent-1', 'mem-123', 1699886400000)
        """
        # Client-side validation
        validate_memory_space_id(memory_space_id)
        validate_memory_id(memory_id)
