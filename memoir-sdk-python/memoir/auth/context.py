"""
Memoir SDK - Auth Context Creation
...
def create_auth_context(
    ...
    This is the recommended way to create an AuthContext for the Memoir SDK.
...
def validate_auth_context(context: AuthContext) -> bool:
    ...
    Example:
        >>> from memoir.auth import validate_auth_context
        >>> from memoir.types import AuthContext
        >>>
