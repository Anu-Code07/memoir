...
class MutableAPI:
    ...
    async def set(
        ...
        Example:
            >>> record = await memoir.mutable.set('inventory', 'widget-qty', 100)
            >>> record = await memoir.mutable.set(
            ...     'config', 'timeout', 30,
    ...
    async def get(self, namespace: str, key: str) -> Optional[Any]:
        ...
        Example:
            >>> qty = await memoir.mutable.get('inventory', 'widget-qty')
        """
        # Client-side validation
        validate_namespace(namespace)
        validate_namespace_format(namespace)
    ...
    async def increment(
        ...
        Example:
            >>> await memoir.mutable.increment('counters', 'page-views', 10)
        """
        # Client-side validation
        validate_namespace(namespace)
        validate_namespace_format(namespace)
    ...
    async def decrement(
        ...
        Example:
            >>> await memoir.mutable.decrement('inventory', 'widget-qty', 5)
        """
        # Client-side validation
        validate_namespace(namespace)
        validate_namespace_format(namespace)
    ...
    async def get_record(self, namespace: str, key: str) -> Optional[MutableRecord]:
        ...
        Example:
            >>> record = await memoir.mutable.get_record('config', 'timeout')
        """
        # Client-side validation
        validate_namespace(namespace)
        validate_namespace_format(namespace)
    ...
    async def delete(
        ...
        Example:
            >>> await memoir.mutable.delete('inventory', 'discontinued-widget')
        """
        # Client-side validation
        validate_namespace(namespace)
        validate_namespace_format(namespace)
    ...
    async def list(self, filter: ListMutableFilter) -> List[MutableRecord]:
        ...
        Example:
            >>> from memoir.types import ListMutableFilter
            >>> items = await memoir.mutable.list(ListMutableFilter(
            ...     namespace='inventory',
            ...     key_prefix='widget-',
            ...     sort_by='updatedAt',
            ...     sort_order='desc',
    ...
    async def count(self, filter: CountMutableFilter) -> int:
        ...
        Example:
            >>> from memoir.types import CountMutableFilter
            >>> count = await memoir.mutable.count(CountMutableFilter(
            ...     namespace='inventory',
    ...
    async def purge_namespace(
        ...
        Example:
            >>> from memoir.types import PurgeNamespaceOptions
            >>> # Preview what would be deleted
            >>> preview = await memoir.mutable.purge_namespace(
            ...     'temp-cache',
            ...
            >>>
            >>> # Actually delete
            >>> result = await memoir.mutable.purge_namespace('temp-cache')
    ...
    async def purge_many(self, filter: PurgeManyMutableFilter) -> Dict[str, Any]:
        ...
        Example:
            >>> from memoir.types import PurgeManyMutableFilter
            >>> # Delete keys with prefix
            >>> await memoir.mutable.purge_many(PurgeManyMutableFilter(
            ...     namespace='cache',
            ...     key_prefix='temp-',
            ... ))
            >>>
