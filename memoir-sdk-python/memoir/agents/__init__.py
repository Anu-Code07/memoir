...
from ..errors import AgentCascadeDeletionError, MemoirError, ErrorCode  # noqa: F401
from ..types import (
    AgentFilters,
    AgentRegistration,
...
class AgentsAPI:
    ...
    async def register(self, agent: AgentRegistration) -> RegisteredAgent:
        ...
        Example:
            >>> agent = await memoir.agents.register(
            ...     AgentRegistration(
            ...         id='support-agent',
    ...
    async def get(self, agent_id: str) -> Optional[RegisteredAgent]:
        ...
        Example:
            >>> agent = await memoir.agents.get('support-agent')
        """
        # Validate agent_id
    ...
    async def search(self, filters: AgentFilters) -> List[RegisteredAgent]:
        ...
        Example:
            >>> support_agents = await memoir.agents.search(
    ...
    async def list(
        ...
        Example:
            ...
            >>>
            >>> # List with filters
            >>> agents = await memoir.agents.list(AgentFilters(
            ...     status="active",
            ...     limit=50,
    ...
    async def get_stats(self, agent_id: str) -> Dict[str, Any]:
        ...
        Example:
            >>> stats = await memoir.agents.get_stats('support-agent')
        """
        # Validate agent_id
        validate_agent_id(agent_id, "agent_id")
    ...
    async def count(self, filters: Optional[AgentFilters] = None) -> int:
        ...
        Example:
            >>> total = await memoir.agents.count()
            >>> active = await memoir.agents.count(AgentFilters(status='active'))
        """
    ...
    async def update(
        ...
        Example:
            >>> updated = await memoir.agents.update(
            ...     'support-agent',
    ...
    async def unregister(
        ...
        Example:
            ...
            >>> result = await memoir.agents.unregister(
            ...     'old-agent',
    ...
    async def unregister_many(
        ...
        Example:
            ...
            >>> result = await memoir.agents.unregister_many(
    ...
    async def update_many(
        ...
        Example:
            ...
            >>> result = await memoir.agents.update_many(
            ...     AgentFilters(metadata={'team': 'support'}),
            ...
            >>> await memoir.agents.update_many(
    ...
    async def export(self, options: ExportAgentsOptions) -> ExportAgentsResult:
        ...
        Example:
            ...
            >>> result = await memoir.agents.export(
            ...
            >>> csv = await memoir.agents.export(
            ...     ExportAgentsOptions(
