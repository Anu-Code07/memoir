...
from memoir.errors import MemoirError, ErrorCode
...
class AsyncConvexClient:
    ...
    async def query(self, name: str, args: Dict[str, Any]) -> Any:
        ...
        Raises:
            MemoirError: All Convex exceptions are wrapped as MemoirError for consistent error handling
        """
        ...
        try:
            ...
            # Always wrap as MemoirError for consistent error handling
            # This ensures callers can rely on catching MemoirError type
            raise MemoirError(
