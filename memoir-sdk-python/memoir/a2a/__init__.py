...
from ..errors import A2ATimeoutError, MemoirError, ErrorCode  # noqa: F401
from ..types import (
    A2ABroadcastParams,
    A2ABroadcastResult,
    A2AConversation,
...
class A2AAPI:
    ...
    async def request(self, params: A2ARequestParams) -> A2AResponse:
        ...
        Example:
            >>> try:
            ...     response = await memoir.a2a.request(
            ...         A2ARequestParams(
    ...
    async def broadcast(self, params: A2ABroadcastParams) -> A2ABroadcastResult:
        ...
        Example:
            >>> result = await memoir.a2a.broadcast(
            ...     A2ABroadcastParams(
    ...
    async def get_conversation(
        ...
        *,
        ...
        Example:
            ...
            >>> convo = await memoir.a2a.get_conversation(
            ...
            >>> from memoir.types import A2AConversationFilters
            >>> convo = await memoir.a2a.get_conversation(
            ...     'finance-agent', 'hr-agent',
