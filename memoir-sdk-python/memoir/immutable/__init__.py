...
class ImmutableAPI:
    ...
    async def store(
        ...
        Example:
            >>> article = await memoir.immutable.store(
            ...     ImmutableEntry(
            ...         type='kb-article',
            ...         id='refund-guide',
    ...
    async def get(self, type: str, id: str) -> Optional[ImmutableRecord]:
        ...
        Example:
            >>> article = await memoir.immutable.get('kb-article', 'refund-policy')
        """
        # CLIENT-SIDE VALIDATION
    ...
    async def get_version(
        ...
        Example:
            >>> v1 = await memoir.immutable.get_version('kb-article', 'guide-1', 1)
        """
        # CLIENT-SIDE VALIDATION
        validate_type(type, "type")
        validate_id(id, "id")
    ...
    async def get_history(self, type: str, id: str) -> List[ImmutableVersionExpanded]:
        ...
        Example:
            >>> history = await memoir.immutable.get_history('policy', 'max-refund')
        """
        # CLIENT-SIDE VALIDATION
        validate_type(type, "type")
        validate_id(id, "id")
    ...
    async def get_at_timestamp(
        ...
        Example:
            >>> policy = await memoir.immutable.get_at_timestamp(
    ...
    async def list(
        ...
        Example:
            >>> articles = await memoir.immutable.list(
    ...
    async def search(
        ...
        Example:
            >>> results = await memoir.immutable.search(
    ...
    async def count(
        ...
        Example:
            >>> total = await memoir.immutable.count(
    ...
    async def purge(self, type: str, id: str) -> PurgeImmutableResult:
        ...
        Example:
            >>> result = await memoir.immutable.purge('kb-article', 'old-article')
    ...
    async def purge_many(
        ...
        Example:
            >>> result = await memoir.immutable.purge_many(
    ...
    async def purge_versions(
        ...
        Example:
            >>> result = await memoir.immutable.purge_versions(
