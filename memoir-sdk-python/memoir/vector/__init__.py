...
class VectorAPI:
    ...
    async def store(
        ...
        Example:
            >>> memory = await memoir.vector.store(
            ...     'agent-1',
            ...     StoreMemoryInput(
    ...
    async def get(
        ...
        Example:
            >>> memory = await memoir.vector.get('agent-1', 'mem-abc123')
        """
        # Client-side validation
        validate_memory_space_id(memory_space_id)
    ...
    async def search(
        ...
        Example:
            >>> results = await memoir.vector.search(
            ...     'agent-1',
            ...     'user preferences',
    ...
    async def update(
        ...
        Example:
            >>> updated = await memoir.vector.update(
            ...     'agent-1', 'mem-123',
    ...
    async def update_many(
        ...
        Example:
            >>> result = await memoir.vector.update_many(
            ...     'agent-1',
            ...     source_type='system',
            ...     importance=20
            ... )
    ...
    async def delete_many(
        ...
        Example:
            >>> result = await memoir.vector.delete_many(
            ...     'agent-1',
            ...     source_type='system'
            ... )
        """
    ...
    async def count(
        ...
        Example:
            >>> total = await memoir.vector.count('agent-1')
        """
        # Client-side validation
        validate_memory_space_id(memory_space_id)
    ...
    async def export(
        ...
        Example:
            >>> exported = await memoir.vector.export(
            ...     'agent-1',
            ...     user_id='user-123',
            ...     format='json'
            ... )
    ...
    async def archive(
        ...
        Example:
            >>> result = await memoir.vector.archive('agent-1', 'mem-123')
        """
        # Client-side validation
        validate_memory_space_id(memory_space_id)
        validate_memory_id(memory_id)
    ...
    async def restore_from_archive(
        ...
        Example:
            >>> result = await memoir.vector.restore_from_archive('agent-1', 'mem-123')
    ...
    async def get_version(
        ...
        Example:
            >>> v1 = await memoir.vector.get_version('agent-1', 'mem-123', 1)
        """
        # Client-side validation
        validate_memory_space_id(memory_space_id)
        validate_memory_id(memory_id)
    ...
    async def get_history(
        ...
        Example:
            >>> history = await memoir.vector.get_history('agent-1', 'mem-123')
        """
        # Client-side validation
        validate_memory_space_id(memory_space_id)
        validate_memory_id(memory_id)
    ...
    async def get_at_timestamp(
        ...
        Example:
            >>> historical = await memoir.vector.get_at_timestamp(
