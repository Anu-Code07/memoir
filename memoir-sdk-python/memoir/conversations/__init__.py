...
from ..errors import MemoirError, ErrorCode  # noqa: F401
from ..types import (
    AddMessageInput,
    AddMessageOptions,
    ApproveMessageInput,
...
class ConversationsAPI:
    ...
    async def create(
        ...
        Example:
            >>> conversation = await memoir.conversations.create(
            ...     CreateConversationInput(
    ...
    async def get(
        ...
        Example:
            >>> conversation = await memoir.conversations.get('conv-abc123')

            >>> # Get without messages (faster for metadata-only queries)
            >>> conv = await memoir.conversations.get('conv-abc123', GetConversationOptions(
    ...
    async def add_message(
        ...
        Example:
            >>> conversation = await memoir.conversations.add_message(
            ...     AddMessageInput(
    ...
    async def list(
        ...
        *,
        ...
        Example:
            >>> result = await memoir.conversations.list(ListConversationsFilter(
            ...     user_id='user-123',
            ...     limit=10
            ... ))
            ...
            >>> result = await memoir.conversations.list(memory_space_id='space-123')

            >>> # With pagination and sorting
            >>> page2 = await memoir.conversations.list(ListConversationsFilter(
            ...
            >>> recent = await memoir.conversations.list(ListConversationsFilter(
            ...     created_after=int(time.time() * 1000) - 7 * 24 * 60 * 60 * 1000,
            ... ))

            >>> # Multi-tenant filtering
            >>> tenant_convs = await memoir.conversations.list(tenant_id='tenant-abc')
        """
    ...
    async def count(
        ...
        *,
        ...
        Example:
            >>> count = await memoir.conversations.count(CountConversationsFilter(
            ...     memory_space_id='user-123-personal'
            ... ))

            >>> # Using convenience kwargs
            >>> count = await memoir.conversations.count(memory_space_id='space-123')
        """
        # Build filter from kwargs if no filter object provided
    ...
    async def delete(
        ...
        Example:
            >>> result = await memoir.conversations.delete('conv-abc123')
    ...
    async def delete_many(
        ...
        Example:
            ...
            >>> preview = await memoir.conversations.delete_many(
            ...     {'user_id': 'user-123'},
            ...
            >>> # Execute deletion
            >>> result = await memoir.conversations.delete_many({
            ...     'memory_space_id': 'user-123-personal',
            ...     'user_id': 'user-123',
            ...     'type': 'user-agent',
            ... })
    ...
    async def get_message(
        ...
        Example:
            >>> message = await memoir.conversations.get_message('conv-123', 'msg-456')
        """
        validate_required_string(conversation_id, "conversation_id")
    ...
    async def get_messages_by_ids(
        ...
        Example:
            >>> messages = await memoir.conversations.get_messages_by_ids(
    ...
    async def find_conversation(
        ...
        Example:
            >>> existing = await memoir.conversations.find_conversation(
            ...     memory_space_id='user-123-personal',
            ...     type='user-agent',
            ...     user_id='user-123'
            ... )
    ...
    async def get_or_create(self, input: CreateConversationInput) -> Conversation:
        ...
        Example:
            >>> conversation = await memoir.conversations.get_or_create(
            ...     CreateConversationInput(
            ...         memory_space_id='user-123-personal',
            ...         type='user-agent',
            ...         participants=ConversationParticipants(
    ...
    async def get_history(
        ...
        Example:
            >>> history = await memoir.conversations.get_history(
            ...     'conv-abc123',
            ...     GetHistoryOptions(limit=20, offset=0, sort_order='desc')
            ... )

            >>> # Filter by date range
            >>> recent = await memoir.conversations.get_history(
            ...     'conv-abc123',
            ...     GetHistoryOptions(
            ...
            >>> # Filter by roles
            >>> user_messages = await memoir.conversations.get_history(
            ...     'conv-abc123',
    ...
    async def search(
        ...
        Example:
            >>> results = await memoir.conversations.search(
            ...     SearchConversationsInput(
            ...         query='password',
            ...
            >>> # Search with options
            >>> fuzzy_results = await memoir.conversations.search(
            ...     SearchConversationsInput(
    ...
    async def export(
        ...
        Example:
            >>> exported = await memoir.conversations.export(
            ...     format='json',
            ...     memory_space_id='user-123-personal',
            ...     user_id='user-123',
    ...
    async def check_access(
        ...
        Example:
            >>> access = await memoir.conversations.check_access(
            ...     CheckAccessInput(
            ...         conversation_id='conv-abc123',
            ...         user_id='user-456'
            ...     )
    ...
    async def set_visibility(
        ...
        Example:
            ...
            >>> updated = await memoir.conversations.set_visibility(
            ...     SetVisibilityInput(
            ...         conversation_id='conv-abc123',
            ...         visibility='public'
            ...     )
            ...
            >>> await memoir.conversations.set_visibility(
            ...     SetVisibilityInput(
            ...         conversation_id='conv-abc123',
            ...         visibility='space'
            ...     )
    ...
    async def share(
        ...
        Example:
            >>> from memoir.sharing import build_share_url
            >>>
            >>> # Create a public link share
            >>> result = await memoir.conversations.share(
            ...     CreateShareInput(
            ...         conversation_id='conv-abc123',
            ...         grant_type='link',
    ...
    async def revoke_share(
        ...
        Example:
            >>> result = await memoir.conversations.revoke_share('share-abc123')
    ...
    async def list_shares(
        ...
        Example:
            ...
            >>> shares = await memoir.conversations.list_shares(
            ...     'conv-abc123',
            ...     status='active'
            ... )
        """
    ...
    async def get_share(
        ...
        Example:
            >>> share = await memoir.conversations.get_share('share-abc123')
    ...
    async def check_share_access(
        ...
        Example:
            >>> access = await memoir.conversations.check_share_access(
            ...     conversation_id='conv-abc123',
            ...     user_id='user-456'
            ... )
    ...
    async def snapshot(
        ...
        Example:
            >>> result = await memoir.conversations.snapshot(
            ...     CreateSnapshotInput(
            ...         conversation_id='conv-abc123',
            ...         redact_pii=True,
            ...     )
    ...
    async def approve_message(
        ...
        Example:
            >>> await memoir.conversations.approve_message(
            ...     ApproveMessageInput(
            ...         conversation_id='conv-abc123',
            ...         message_id='msg-456',
            ...     )
    ...
    async def reject_message(
        ...
        Example:
            >>> await memoir.conversations.reject_message(
            ...     ApproveMessageInput(
            ...         conversation_id='conv-abc123',
            ...         message_id='msg-456',
            ...     )
