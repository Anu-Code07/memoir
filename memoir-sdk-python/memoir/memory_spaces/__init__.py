...
class MemorySpacesAPI:
    ...
    async def register(
        ...
        Example:
            >>> space = await memoir.memory_spaces.register(
            ...     RegisterMemorySpaceParams(
    ...
    async def get(self, memory_space_id: str) -> Optional[MemorySpace]:
        ...
        Example:
            >>> space = await memoir.memory_spaces.get('user-123-personal')
        """
    ...
    async def list(
        ...
        *,
        ...
        Example:
            ...
            >>> result = await memoir.memory_spaces.list(
            ...     ListMemorySpacesFilter(type='personal', status='active', limit=20)
            ... )
            >>>
            >>> # Using kwargs (backward compatible)
            >>> result = await memoir.memory_spaces.list(type='personal', status='active')
        """
    ...
    async def search(
        ...
        Example:
            >>> results = await memoir.memory_spaces.search('engineering')
        """
    ...
    async def update(
        ...
        Example:
            ...
            >>> await memoir.memory_spaces.update(
            ...     'team-alpha',
    ...
    async def update_participants(
        ...
        *,
        ...
        Example:
            ...
            >>> await memoir.memory_spaces.update_participants(
            ...     'team-alpha',
    ...
    async def archive(
        ...
        Example:
            >>> await memoir.memory_spaces.archive(
            ...     'project-apollo',
    ...
    async def reactivate(self, memory_space_id: str) -> MemorySpace:
        ...
        Example:
            >>> await memoir.memory_spaces.reactivate('user-123-personal')
        """
        validate_memory_space_id(memory_space_id)
    ...
    async def add_participant(
        ...
        Example:
            >>> await memoir.memory_spaces.add_participant(
            ...     'team-alpha',
    ...
    async def remove_participant(
        ...
        Example:
            >>> await memoir.memory_spaces.remove_participant('team-alpha', 'tool-analyzer')
        """
        validate_memory_space_id(memory_space_id)
        if not participant_id or not participant_id.strip():
            raise MemorySpaceValidationError(
    ...
    async def find_by_participant(self, participant_id: str) -> List[MemorySpace]:
        ...
        Example:
            >>> spaces = await memoir.memory_spaces.find_by_participant('user-123')
        """
        if not participant_id or not participant_id.strip():
            raise MemorySpaceValidationError(
                "participantId is required and cannot be empty",
    ...
    async def get_stats(
        ...
        Example:
            >>> # Basic stats
            >>> stats = await memoir.memory_spaces.get_stats('team-alpha')
            ...
            >>> stats = await memoir.memory_spaces.get_stats(
    ...
    async def count(
        ...
        Example:
            >>> total = await memoir.memory_spaces.count(type='personal')
        """
        if type is not None:
            validate_memory_space_type(type)
        if status is not None:
