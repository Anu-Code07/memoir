...
class FactsAPI:
    ...
    async def store_with_dedup(
        ...
        Example:
            >>> result = await memoir.facts.store_with_dedup(
            ...     StoreFactParams(
            ...         memory_space_id='agent-1',
            ...         fact='User prefers dark mode',
            ...         fact_type='preference',
    ...
    async def get(
        ...
        Example:
            >>> fact = await memoir.facts.get('agent-1', 'fact-123')
        """
    ...
    async def search(
        ...
        Example:
            ...
            >>> results = await memoir.facts.search(
            ...     'agent-1',
            ...     'food preferences',
            ...     SearchFactsOptions(
            ...         user_id='user-123',
    ...
    async def semantic_search(
        ...
        Example:
            ...
            >>> results = await memoir.facts.semantic_search(
            ...     'agent-1',
            ...     query_embedding,
            ...     SemanticSearchFactsOptions(
            ...         min_confidence=50,
    ...
    async def update(
        ...
        Example:
            ...
            >>> updated = await memoir.facts.update(
            ...     'agent-1', 'fact-123',
    ...
    async def delete(
        ...
        Example:
            >>> result = await memoir.facts.delete('agent-1', 'fact-123')
    ...
    async def delete_many(
        ...
        Example:
            >>> from memoir.types import DeleteManyFactsParams
            >>> # Delete all facts in a memory space
            >>> result = await memoir.facts.delete_many(
            ...
            >>> gdpr_result = await memoir.facts.delete_many(
            ...     DeleteManyFactsParams(
            ...         memory_space_id='agent-1',
            ...
            >>> pref_result = await memoir.facts.delete_many(
            ...     DeleteManyFactsParams(
            ...         memory_space_id='agent-1',
            ...         fact_type='preference'
            ...     )
    ...
    async def count(
        ...
        Example:
            ...
            >>> total = await memoir.facts.count(
            ...     CountFactsFilter(
            ...         memory_space_id='agent-1',
            ...         user_id='user-123',
            ...         fact_type='preference',
    ...
    async def query_by_subject(
        ...
        Example:
            ...
            >>> user_facts = await memoir.facts.query_by_subject(
            ...     QueryBySubjectFilter(
            ...         memory_space_id='agent-1',
            ...         subject='user-123',
            ...         user_id='user-123',
    ...
    async def query_by_relationship(
        ...
        Example:
            ...
            >>> work_places = await memoir.facts.query_by_relationship(
            ...     QueryByRelationshipFilter(
            ...         memory_space_id='agent-1',
            ...         subject='user-123',
            ...         predicate='works_at',
    ...
    async def get_history(
        ...
        Example:
            >>> history = await memoir.facts.get_history('agent-1', 'fact-123')
        """
        validate_memory_space_id(memory_space_id)
        validate_required_string(fact_id, "fact_id")
        validate_fact_id_format(fact_id)
    ...
    async def export(
        ...
        Example:
            >>> exported = await memoir.facts.export(
            ...     'agent-1',
            ...     format='json',
            ...     fact_type='preference'
            ... )
    ...
    async def consolidate(
        ...
        Example:
            >>> result = await memoir.facts.consolidate(
            ...     'agent-1',
    ...
    def configure_belief_revision(
        ...
        Example:
            >>> memoir.facts.configure_belief_revision(
    ...
    async def revise(self, params: ReviseParams) -> ReviseResult:
        ...
        Example:
            >>> result = await memoir.facts.revise(ReviseParams(
    ...
    async def check_conflicts(self, params: ReviseParams) -> ConflictCheckResult:
        ...
        Example:
            >>> result = await memoir.facts.check_conflicts(ReviseParams(
            ...     memory_space_id="space-1",
            ...     fact=ConflictCandidate(
    ...
    async def supersede(
        ...
        *,
        ...
        Example:
            >>> result = await memoir.facts.supersede(
            ...     memory_space_id="space-1",
    ...
    async def history(self, fact_id: str, limit: Optional[int] = None) -> List[FactChangeEvent]:
        ...
        Example:
            >>> events = await memoir.facts.history("fact-123")
            >>> for event in events:
    ...
    async def get_changes(self, filter: ChangeFilter) -> List[FactChangeEvent]:
        ...
        Example:
            ...
            >>> changes = await memoir.facts.get_changes(ChangeFilter(
            ...     memory_space_id="space-1",
    ...
    async def get_supersession_chain(self, fact_id: str) -> List[SupersessionChainEntry]:
        ...
        Example:
            >>> chain = await memoir.facts.get_supersession_chain("fact-456")
            >>> for entry in chain:
    ...
    async def get_activity_summary(
        ...
        Example:
            >>> summary = await memoir.facts.get_activity_summary("space-1", 24)
