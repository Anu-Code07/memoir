...
class GovernanceAPI:
    ...
    rules across all Memoir storage layers (Conversations, Immutable, Mutable, Vector).
    ...
    Example:
        >>> # Apply GDPR template
        >>> policy = await memoir.governance.get_template("GDPR")
        >>> await memoir.governance.set_policy(
        ...     GovernancePolicy(
        ...
        >>> await memoir.governance.set_agent_override(
        ...     "audit-agent",
        ...     GovernancePolicy(
        ...         vector=VectorPolicy(
    ...
    async def get_policy(self, scope: Optional[PolicyScope] = None) -> GovernancePolicy:
        ...
        Example:
            >>> # Get org-wide policy
            >>> org_policy = await memoir.governance.get_policy(
            ...     PolicyScope(organization_id="org-123")
            ... )
            >>>
            >>> # Get memory-space-specific policy
            >>> space_policy = await memoir.governance.get_policy(
    ...
    async def get_template(self, template: ComplianceTemplate) -> GovernancePolicy:
        ...
        Example:
            >>> gdpr_policy = await memoir.governance.get_template("GDPR")
            >>> await memoir.governance.set_policy(
            ...     GovernancePolicy(
            ...         organization_id="org-123",
            ...         **gdpr_policy.to_dict()
    ...
    async def enforce(self, options: EnforcementOptions) -> EnforcementResult:
        ...
        Example:
            >>> result = await memoir.governance.enforce(
            ...     EnforcementOptions(
    ...
    async def simulate(self, options: SimulationOptions) -> SimulationResult:
        ...
        Example:
            >>> impact = await memoir.governance.simulate(
            ...     SimulationOptions(
            ...         organization_id="org-123",
            ...         vector=VectorPolicy(
    ...
    async def get_compliance_report(
        ...
        Example:
            ...
            >>>
            >>> report = await memoir.governance.get_compliance_report(
            ...     ComplianceReportOptions(
            ...         organization_id="org-123",
    ...
    async def get_enforcement_stats(
        ...
        Example:
            >>> stats = await memoir.governance.get_enforcement_stats(
