...
class ArtifactsAPI:
    ...
    Example:
        >>> from memoir.types import CreateArtifactOptions
        >>> artifact = await memoir.artifacts.create(
        ...     CreateArtifactOptions(
        ...         title="Code Review",
        ...         content="# Code Review\\n\\nLGTM!",
        ...         kind="code",
    ...
    async def create(self, options: CreateArtifactOptions) -> Artifact:
        ...
        Raises:
            ...
            MemoirError: If backend operation fails
    ...
    async def get(self, artifact_id: str) -> Optional[Artifact]:
        ...
        Example:
            >>> artifact = await memoir.artifacts.get("meeting-notes-2024")
            >>> if artifact:
    ...
    async def update(
        ...
        Raises:
            ArtifactsValidationError: If validation fails
            MemoirError: If artifact not found or update fails

        Example:
            >>> from memoir.types import UpdateArtifactOptions
            >>> artifact = await memoir.artifacts.update(
            ...     "meeting-notes-2024",
    ...
    async def delete(self, artifact_id: str, hard: bool = False) -> Dict[str, Any]:
        ...
        Raises:
            ArtifactsValidationError: If validation fails
            MemoirError: If artifact not found or delete fails

        Example:
            >>> result = await memoir.artifacts.delete("old-draft-doc")
            >>> if result["deleted"]:
    ...
    async def list(self, filter: ListArtifactsFilter) -> List[Artifact]:
        ...
        Example:
            >>> from memoir.types import ListArtifactsFilter
            >>> artifacts = await memoir.artifacts.list(
            ...     ListArtifactsFilter(
            ...         kind="code",
    ...
    async def count(self, filter: CountArtifactsFilter) -> int:
        ...
        Example:
            >>> from memoir.types import CountArtifactsFilter
            >>> draft_count = await memoir.artifacts.count(
    ...
    async def undo(self, artifact_id: str) -> UndoRedoResult:
        ...
        Raises:
            MemoirError: If no previous version exists or undo fails

        Example:
            >>> # Revert to previous version
            >>> result = await memoir.artifacts.undo("meeting-notes-2024")
    ...
    async def redo(self, artifact_id: str) -> UndoRedoResult:
        ...
        Raises:
            MemoirError: If no redo available or redo fails

        Example:
            >>> # Redo after an undo
            >>> result = await memoir.artifacts.redo("meeting-notes-2024")
    ...
    async def get_history(self, artifact_id: str) -> List[ArtifactVersion]:
        ...
        Example:
            >>> history = await memoir.artifacts.get_history("meeting-notes-2024")
    ...
    async def get_version(self, artifact_id: str, version: int) -> Optional[ArtifactVersion]:
        ...
        Example:
            >>> version = await memoir.artifacts.get_version("meeting-notes-2024", 2)
            >>> if version:
    ...
    async def start_streaming(self, params: StartStreamingParams) -> StartStreamingResult:
        ...
        Example:
            >>> from memoir.types import StartStreamingParams
            >>> result = await memoir.artifacts.start_streaming(
    ...
    async def append_content(self, params: AppendContentParams) -> AppendContentResult:
        ...
        Example:
            >>> from memoir.types import AppendContentParams
            >>> result = await memoir.artifacts.append_content(
            ...     AppendContentParams(
    ...
    async def pause_streaming(
        ...
        Example:
            >>> result = await memoir.artifacts.pause_streaming(
    ...
    async def resume_streaming(
        ...
        Example:
            >>> result = await memoir.artifacts.resume_streaming(
            ...     "code-gen-001", "sess-abc123"
            ... )
    ...
    async def cancel_streaming(
        ...
        Example:
            >>> result = await memoir.artifacts.cancel_streaming(
            ...     "code-gen-001", "sess-abc123"
            ... )
    ...
    async def finalize_streaming(
        ...
        Example:
            >>> from memoir.types import FinalizeStreamingParams
            >>> result = await memoir.artifacts.finalize_streaming(
            ...     FinalizeStreamingParams(
            ...         artifact_id="code-gen-001",
            ...         session_id="sess-abc123",
            ...     )
    ...
    async def set_streaming_state(
        ...
        Raises:
            ...
            MemoirError: If state transition is not allowed

        Example:
            >>> # Mark an artifact as having an error
            >>> result = await memoir.artifacts.set_streaming_state(
            ...     "code-gen-001", "error"
            ... )
    ...
    async def upload_file(
        ...
        Example:
            ...
            >>> # 1. Get upload URL
            >>> upload_info = await memoir.artifacts.generate_upload_url(
            ...
            >>> artifact = await memoir.artifacts.complete_artifact_upload(...)
        """
    ...
    async def get_file_url(self, artifact_id: str) -> Optional[str]:
        ...
        Example:
            >>> url = await memoir.artifacts.get_file_url("meeting-notes-2024")
            >>> if url:
    ...
    async def set_file_ref(
        ...
        Example:
            >>> from memoir.types import FileReference
            >>>
            ...
            ... )
            >>> artifact = await memoir.artifacts.set_file_ref(
    ...
    async def detach_file(
        ...
        Example:
            ...
            >>> result = await memoir.artifacts.detach_file("meeting-notes-2024")
            >>> print(f"Detached file: {result.previous_file_ref}")
            >>>
            >>> # Detach and delete the file
            >>> result = await memoir.artifacts.detach_file(
