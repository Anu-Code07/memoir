...
class AttachmentsAPI:
    ...
    Example:
        >>> # Generate upload URL
        >>> result = await memoir.attachments.generate_upload_url()
        >>> # Upload file to result.upload_url
        >>> # Then attach the file
        >>> from memoir.types import AttachParams
        >>> attachment = await memoir.attachments.attach(
        ...     AttachParams(
    ...
    async def get(self, attachment_id: str) -> Optional[Attachment]:
        ...
        Example:
            >>> attachment = await memoir.attachments.get("attach-abc123")
            >>> if attachment:
    ...
    async def get_url(self, attachment_id: str) -> Optional[str]:
        ...
        Example:
            >>> url = await memoir.attachments.get_url("attach-abc123")
            >>> if url:
    ...
    async def list(self, filter: ListAttachmentsFilter) -> ListAttachmentsResult:
        ...
        Example:
            >>> from memoir.types import ListAttachmentsFilter
            >>> result = await memoir.attachments.list(
            ...     ListAttachmentsFilter(
            ...         memory_space_id="my-space",
            ...         type="image",
            ...         limit=20,
    ...
    async def get_by_conversation(
        ...
        Example:
            >>> attachments = await memoir.attachments.get_by_conversation("conv-123")
    ...
    async def get_by_message(self, message_id: str) -> List[Attachment]:
        ...
        Example:
            >>> attachments = await memoir.attachments.get_by_message("msg-123")
    ...
    async def count(
        ...
        Example:
            >>> count = await memoir.attachments.count(
            ...     memory_space_id="my-space",
            ...     type="image",
            ... )
    ...
    async def delete(self, attachment_id: str) -> bool:
        ...
        Example:
            >>> success = await memoir.attachments.delete("attach-abc123")
            >>> if success:
    ...
    async def delete_many(self, attachment_ids: List[str]) -> DeleteManyAttachmentsResult:
        ...
        Example:
            >>> result = await memoir.attachments.delete_many([
            ...     "attach-123",
            ...     "attach-456",
            ... ])
