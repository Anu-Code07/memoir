...
export class A2AAPI {
  ...
  async send(params: A2ASendParams): Promise<A2AMessage> {
    ...
    const result = await this.executeWithResilience(
      () =>
        this.client.mutation(a2aApi.a2a.send, {
          from: params.from,
          to: params.to,
  ...
  async request(params: A2ARequestParams): Promise<A2AResponse> {
    ...
    try {
      ...
      const result = await this.executeWithResilience(
        () =>
          this.client.mutation(a2aApi.a2a.request, {
            from: params.from,
            to: params.to,
            message: params.message,
  ...
  async broadcast(params: A2ABroadcastParams): Promise<A2ABroadcastResult> {
    ...
    const result = await this.executeWithResilience(
      () =>
        this.client.mutation(a2aApi.a2a.broadcast, {
          from: params.from,
          to: params.to,
          message: params.message,
          userId: params.userId,
  ...
  async getConversation(
    ...
    const result = await this.executeWithResilience(
      () =>
        this.client.query(a2aApi.a2a.getConversation, {
          agent1,
          agent2,
